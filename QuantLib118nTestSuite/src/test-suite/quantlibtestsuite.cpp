...
namespace {
    ...
    void configure(QuantLib::Date evaluationDate) {
        ...
        */
        ...
        // QuantLib::settings->includeReferenceDateCashFlows() = true;
        // QuantLib::settings->includeTodaysCashFlows() = boost::none;
        EvaluationDateSingleton::instance().setDate(evaluationDate);
//        getSettingsInstance()->evaluationDate() = evaluationDate;
    }
