...
namespace inflation_volatility_test {
    ...
    void setup(Settings* settings) {
        ...
        settings->evaluationDate() = eval;

        yoyIndexUK = ext::shared_ptr<YoYInflationIndex>(new YYUKRPIr(settings, true, yoyUK));
        yoyIndexEU = ext::shared_ptr<YoYInflationIndex>(new YYEUHICPr(settings, true, yoyEU));
        ...
        ext::shared_ptr<InterpolatedZeroCurve<Cubic> >
            euriborTS(new InterpolatedZeroCurve<Cubic>(settings, d, r, Actual365Fixed()));
        ...
        ext::shared_ptr<InterpolatedZeroCurve<Cubic> >
            gbpLiborTS(new InterpolatedZeroCurve<Cubic>(settings, d, r, Actual365Fixed()));
        ...
        ext::shared_ptr<InterpolatedYoYInflationCurve<Linear> >
            pYTSEU( new InterpolatedYoYInflationCurve<Linear>(settings, 
    ...
    void setupPriceSurface(Settings* settings) {
...
void InflationVolTest::testYoYPriceSurfaceToVol() {
    ...
    ext::shared_ptr<YoYInflationUnitDisplacedBlackCapFloorEngine>
        yoyPricerUD(new YoYInflationUnitDisplacedBlackCapFloorEngine(settings, yoyIndexEU,hVS,nominalEUR)); //hVS
    // N.B. the vol gets set in the stripper ... else no point!

    // cap stripper
    ext::shared_ptr<YoYOptionletStripper> yoyOptionletStripper(
                             new InterpolatedYoYOptionletStripper<Linear>(settings) );
    ...
    ext::shared_ptr<KInterpolatedYoYOptionletVolatilitySurface<Linear> > yoySurf(new
                    KInterpolatedYoYOptionletVolatilitySurface<Linear>(settings, settlementDays,
