...
void DoubleBarrierOptionTest::testEuropeanHaugValues() {
    ...
    for (Size i=0; i<LENGTH(values); i++) {
        ...
        DoubleBarrierOption opt(settings, 
        ...
        ext::shared_ptr<PricingEngine> engine(
                                     new AnalyticDoubleBarrierEngine(settings, stochProcess));
        ...
        engine = ext::shared_ptr<PricingEngine>(
                                     new WulinYongDoubleBarrierEngine(settings, stochProcess));
        opt.setPricingEngine(engine);
        ...
        engine = ext::shared_ptr<PricingEngine>(
              new BinomialDoubleBarrierEngine<CoxRossRubinstein,
                              DiscretizedDoubleBarrierOption>(settings, stochProcess, 
                                                                 300));
        opt.setPricingEngine(engine);
        calculated = opt.NPV();
        expected = values[i].result;
        ...
        engine = ext::shared_ptr<PricingEngine>(
              new BinomialDoubleBarrierEngine<CoxRossRubinstein,
                           DiscretizedDermanKaniDoubleBarrierOption>(settings, 
                                                stochProcess, 300));
        opt.setPricingEngine(engine);
        calculated = opt.NPV();
        expected = values[i].result;
        ...
        if (values[i].barrierType == DoubleBarrier::KnockOut) {
            engine = ext::make_shared<FdHestonDoubleBarrierEngine>(settings, 
    ...
    for (Size i=0; i<LENGTH(values); i++) {
        ...
        for (Size j=0; j<=1; j++) {
           ...
           DoubleBarrier::Type barrierType = static_cast<DoubleBarrier::Type>(j);
            ...
            DoubleBarrierOption doubleBarrierOption(settings, barrierType,
                                                    values[i].barrier1,
                                                    values[i].barrier2,
                                                    values[i].rebate,
                                                    payoff,
            ...
            ext::shared_ptr<PricingEngine> vannaVolgaEngine =
                ext::make_shared<VannaVolgaDoubleBarrierEngine<WulinYongDoubleBarrierEngine> >(settings, 
                                volAtmQuote,
                                vol25PutQuote,
                                vol25CallQuote,
                                Handle<Quote> (spot),
            ...
            vannaVolgaEngine =
                ext::make_shared<VannaVolgaDoubleBarrierEngine<AnalyticDoubleBarrierEngine> >(settings, 
                                volAtmQuote,
                                vol25PutQuote,
                                vol25CallQuote,
                                Handle<Quote> (spot),
