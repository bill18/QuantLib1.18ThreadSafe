...
void VarianceOptionTest::testIntegralHeston() {
    ...
    ext::shared_ptr<HestonProcess> process(new HestonProcess(settings, rTS, qTS, s0,
                                                               v0, kappa, theta,
                                                               sigma, rho));
    ext::shared_ptr<PricingEngine> engine(
                               new IntegralHestonVarianceOptionEngine(settings, process));
    ...
    VarianceOption varianceOption1(settings, payoff, nominal, today, exDate);
    ...
    VarianceOption varianceOption2(settings, payoff, nominal, today, exDate);
