...
void NoArbSabrTest::testConsistencyWithHagan() {
    ...
    SabrSmileSection sabr(settings, tau,f,boost::assign::list_of(alpha)(beta)(nu)(rho));
    NoArbSabrSmileSection noarbsabr(settings, tau,f,boost::assign::list_of(alpha)(beta)(nu)(rho));
