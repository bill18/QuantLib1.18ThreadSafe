...
void JumpDiffusionTest::testMerton76() {
    ...
    */
    ...
    ext::shared_ptr<Merton76Process> stochProcess(
           new Merton76Process(settings, Handle<Quote>(spot),
    ...
    ext::shared_ptr<PricingEngine> engine(
                                       new JumpDiffusionEngine(settings, stochProcess));
...
void JumpDiffusionTest::testGreeks() {
    ...
    ext::shared_ptr<Merton76Process> stochProcess(
          new Merton76Process(settings, Handle<Quote>(spot), qTS, rTS, volTS,
                              Handle<Quote>(jumpIntensity),
                              Handle<Quote>(meanLogJump),
                              Handle<Quote>(jumpVol)));
    ...
    ext::shared_ptr<PricingEngine> engine(
                                 new JumpDiffusionEngine(settings, stochProcess,1e-08));
