...
void SpreadOptionTest::testKirkEngine() {
    ...
    for (Size i=0; i<LENGTH(cases); ++i) {
        ...
        ext::shared_ptr<YieldTermStructure> forwardRate =
            flatRate(settings, today,riskFreeRate,dc);
        ...
        SpreadOption option(settings, payoff, exercise);
