...
void InflationCPICapFloorTest::cpicapfloorpricesurface() {
    ...
    <Bilinear> cpiSurf(common.settings, nominal,
                       common.baseZeroRate,
...
void InflationCPICapFloorTest::cpicapfloorpricer() {
    ...
    ext::shared_ptr<CPICapFloorTermPriceSurface> cpiCFpriceSurf(new InterpolatedCPICapFloorTermPriceSurface
                                                    <Bilinear>(common.settings, nominal,
                                                               common.baseZeroRate,
                                                               common.observationLag,
                                                               common.calendar,
                                                               common.convention,
    ...
    CPICapFloor aCap(common.settings, Option::Call,
                     nominal,
    ...
    ext::shared_ptr<PricingEngine>engine(new InterpolatingCPICapFloorEngine(common.settings, cpiCFsurfUKh));
