...
void MoneyTest::testNone() {
    ...
    Money m3(settings->evaluationDate(), 500000.0 , EUR);
    ...
    Money expected(settings->evaluationDate(), x, EUR);
...
void MoneyTest::testBaseCurrency() {
    ...
    Money m2(settings->evaluationDate(), 100000.0 , EUR);
    Money m3(settings->evaluationDate(), 500000.0 , USD);
...
void MoneyTest::testAutomated() {
    ...
    Money expected(settings->evaluationDate(), x, GBP);
