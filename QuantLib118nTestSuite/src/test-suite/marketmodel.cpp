...
namespace market_model_test {
    ...
    void setup(Settings* env) {
        ...
        dates =Schedule(settings->evaluationDate(), todaysDate, endDate, Period(Semiannual),
...
void testMultiProductComposite(Settings* settings, const MarketModelMultiProduct& product,
...
void MarketModelTest::testAllMultiStepProducts() {
    ...
    product.finalize();
    testMultiProductComposite(settings, product, subProductExpectedValues,
        testDescription);
}
