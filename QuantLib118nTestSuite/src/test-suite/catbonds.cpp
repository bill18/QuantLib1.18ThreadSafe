...
namespace catbonds_test {
    ...
    struct CommonVars {
        ...
        // cleanup
        QuantLib::Settings xenv;
        Settings* settings = &xenv;
...
void CatBondTest::testRiskFreeAgainstFloatingRateBond() {
    ...
    FloatingCatBond catBond1(vars.settings, settlementDays, vars.faceAmount, sch,
                           index, ActualActual(ActualActual::ISMA),
                           notionalRisk, 
                           ModifiedFollowing, fixingDays,
                           std::vector<Real>(), std::vector<Spread>(),
    ...
    ext::shared_ptr<PricingEngine> catBondEngine(new MonteCarloCatBondEngine(vars.settings, noCatRisk, riskFreeRate));
    ...
    FloatingCatBond catBond2(vars.settings, settlementDays, vars.faceAmount, sch,
                           index, ActualActual(ActualActual::ISMA),
                           notionalRisk,
                           ModifiedFollowing, fixingDays,
                           std::vector<Rate>(), std::vector<Spread>(),
    ...
    ext::shared_ptr<PricingEngine> catBondEngine2(new MonteCarloCatBondEngine(vars.settings, noCatRisk, discountCurve));
    ...
    FloatingCatBond catBond3(vars.settings, settlementDays, vars.faceAmount, sch,
                           index, ActualActual(ActualActual::ISMA),
                           notionalRisk,
                           ModifiedFollowing, fixingDays,
                           std::vector<Real>(), spreads,
...
void CatBondTest::testCatBondInDoomScenario() {
    ...
    FloatingCatBond catBond(vars.settings, settlementDays, vars.faceAmount, sch,
                           index, ActualActual(ActualActual::ISMA),
                           notionalRisk,
                           ModifiedFollowing, fixingDays,
                           std::vector<Rate>(), std::vector<Spread>(),
    ...
    ext::shared_ptr<PricingEngine> catBondEngine(new MonteCarloCatBondEngine(vars.settings, doomCatRisk, discountCurve));
...
void CatBondTest::testCatBondWithDoomOnceInTenYears() {
    ...
    ext::shared_ptr<PricingEngine> catBondEngineRF(new MonteCarloCatBondEngine(vars.settings, noCatRisk, discountCurve));
...
void CatBondTest::testCatBondWithGeneratedEventsProportional() {
    ...
    ext::shared_ptr<PricingEngine> catBondEngine(new MonteCarloCatBondEngine(vars.settings, betaCatRisk, discountCurve));
    catBond.setPricingEngine(catBondEngine);
    setCouponPricer(catBond.cashflows(),pricer);
