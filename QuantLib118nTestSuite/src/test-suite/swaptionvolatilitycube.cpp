        ...
        CommonVars() {
            ...
            atmVolMatrix = RelinkableHandle<SwaptionVolatilityStructure>(
                ext::shared_ptr<SwaptionVolatilityStructure>(new
                    SwaptionVolatilityMatrix(settings, conventions.calendar,
            ...
            termStructure.linkTo(flatRate(settings, 0.05, Actual365Fixed()));
...
void SwaptionVolatilityCubeTest::testAtmVols() {
    ...
    SwaptionVolCube2 volCube(vars.settings, vars.atmVolMatrix,
...
void SwaptionVolatilityCubeTest::testSabrVols() {
    ...
    SwaptionVolCube1 volCube(vars.settings, vars.atmVolMatrix,
                             vars.cube.tenors.options,
                             vars.cube.tenors.swaps,
                             vars.cube.strikeSpreads,
                             vars.cube.volSpreadsHandle,
...
void SwaptionVolatilityCubeTest::testSpreadedCube() {
    ...
    Handle<SwaptionVolatilityStructure> volCube( ext::shared_ptr<SwaptionVolatilityStructure>(new
        SwaptionVolCube1(vars.settings, vars.atmVolMatrix,
                         vars.cube.tenors.options,
                         vars.cube.tenors.swaps,
                         vars.cube.strikeSpreads,
                         vars.cube.volSpreadsHandle,
    ...
    ext::shared_ptr<SwaptionVolatilityStructure> spreadedVolCube(new
        SpreadedSwaptionVolatility(vars.settings, volCube, spreadHandle));
...
void SwaptionVolatilityCubeTest::testObservability() {
    ...
    volCube1_0 = ext::shared_ptr<SwaptionVolCube1>(new SwaptionVolCube1(vars.settings, vars.atmVolMatrix,
                                                                vars.cube.tenors.options,
                                                                vars.cube.tenors.swaps,
                                                                vars.cube.strikeSpreads,
                                                                vars.cube.volSpreadsHandle,
    ...
    volCube1_1 = ext::shared_ptr<SwaptionVolCube1>(new SwaptionVolCube1(vars.settings, vars.atmVolMatrix,
                                                                vars.cube.tenors.options,
                                                                vars.cube.tenors.swaps,
                                                                vars.cube.strikeSpreads,
                                                                vars.cube.volSpreadsHandle,
    ...
    vars.settings->evaluationDate() = referenceDate;

    ext::shared_ptr<SwaptionVolCube2> volCube2_0, volCube2_1;
    // VolCube created before change of reference date
    volCube2_0 = ext::make_shared<SwaptionVolCube2>(vars.settings,   vars.atmVolMatrix,
                                                                vars.cube.tenors.options,
                                                                vars.cube.tenors.swaps,
                                                                vars.cube.strikeSpreads,
                                                                vars.cube.volSpreadsHandle,
    ...
    // VolCube created after change of reference date
    volCube2_1 = ext::make_shared<SwaptionVolCube2>(vars.settings,   vars.atmVolMatrix,
                                                                vars.cube.tenors.options,
                                                                vars.cube.tenors.swaps,
                                                                vars.cube.strikeSpreads,
                                                                vars.cube.volSpreadsHandle,
