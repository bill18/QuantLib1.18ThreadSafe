...
//    RestoreUpdates guard;
    ...
    Handle<YieldTermStructure> yts(
        ext::make_shared<FlatForward>(settings, 0, NullCalendar(), 0.02, Actual365Fixed()));
    ext::shared_ptr<IborIndex> ibor = ext::make_shared<Euribor>(settings, 3 * Months, yts);
    ...
    ext::shared_ptr<StrippedOptionletAdapter> vol =
        ext::make_shared<StrippedOptionletAdapter>(settings, ext::make_shared<StrippedOptionlet>(settings, 
