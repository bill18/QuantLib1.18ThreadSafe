...
void ChooserOptionTest::testAnalyticSimpleChooserEngine(){
    ...
    */
    ...
    ext::shared_ptr<PricingEngine> engine =
        ext::make_shared<AnalyticSimpleChooserEngine>(settings, stochProcess);
    ...
    SimpleChooserOption option(settings, choosingDate,strike,exercise);
...
void ChooserOptionTest::testAnalyticComplexChooserEngine(){
    ...
    */
    ...
    ext::shared_ptr<PricingEngine> engine =
        ext::make_shared<AnalyticComplexChooserEngine>(settings, stochProcess);
    ...
    ComplexChooserOption option(settings, choosingDate,callStrike,putStrike,
