    ...
    namespace detail {
        ...
        class quantlib_test_case {
          ...
          public:
            ...
            void operator()() const {
//            	Settings settings;
//                Date before = settings->evaluationDate();
                BOOST_CHECK(true);
                test_();
//                Date after = settings->evaluationDate();
//                if (before != after)
...
//                                << "\n  after:  " << after);
    ...
    ext::shared_ptr<YieldTermStructure>
    flatRate(Settings* settings, Rate forward,
             const DayCounter& dc);
    ...
    ext::shared_ptr<BlackVolTermStructure>
    flatVol(Settings* settings, const ext::shared_ptr<Quote>& volatility,
            const DayCounter& dc);

    ext::shared_ptr<BlackVolTermStructure>
    flatVol(Settings* settings, Volatility volatility,
            const DayCounter& dc);
