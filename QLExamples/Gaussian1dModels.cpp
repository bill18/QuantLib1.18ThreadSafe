...
int main(int argc, char *argv[]) {
    ...
    try {
        ...
        settings->evaluationDate() = refDate;

        std::cout << "\nThe evaluation date for this example is set to "
                  << settings->evaluationDate() << std::endl;
        ...
        Handle<YieldTermStructure> yts6m(ext::make_shared<FlatForward>(settings,
            0, TARGET(), forward6mQuote, Actual365Fixed()));
        Handle<YieldTermStructure> ytsOis(ext::make_shared<FlatForward>(settings,
            0, TARGET(), oisQuote, Actual365Fixed()));

        ext::shared_ptr<IborIndex> euribor6m =
            ext::make_shared<Euribor>(settings, 6 * Months, yts6m);
        ...
        Handle<SwaptionVolatilityStructure> swaptionVol(
            ext::make_shared<ConstantSwaptionVolatility>(settings,
        ...
        Schedule fixedSchedule(settings->evaluationDate(), effectiveDate, maturityDate, 1 * Years, TARGET(),
                               ModifiedFollowing, ModifiedFollowing,
                               DateGeneration::Forward, false);
        Schedule floatingSchedule(settings->evaluationDate(), effectiveDate, maturityDate, 6 * Months,
                                  TARGET(), ModifiedFollowing,
                                  ModifiedFollowing, DateGeneration::Forward,
                                  false);

        ext::shared_ptr<NonstandardSwap> underlying =
            ext::make_shared<NonstandardSwap>(settings, VanillaSwap(settings,
        ...
        ext::shared_ptr<NonstandardSwaption> swaption =
            ext::make_shared<NonstandardSwaption>(settings, underlying, exercise);
        ...
        ext::shared_ptr<Gsr> gsr = ext::make_shared<Gsr>(settings,
            yts6m, stepDates, sigmas, reversion);

        ext::shared_ptr<PricingEngine> swaptionEngine =
            ext::make_shared<Gaussian1dSwaptionEngine>(settings, gsr, 64, 7.0, true,
                                                         false, ytsOis);
        ext::shared_ptr<PricingEngine> nonstandardSwaptionEngine =
            ext::make_shared<Gaussian1dNonstandardSwaptionEngine>(settings,
        ...
        ext::shared_ptr<SwapIndex> swapBase =
            ext::make_shared<EuriborSwapIsdaFixA>(settings, 10 * Years, yts6m, ytsOis);
        ...
        ext::shared_ptr<NonstandardSwap> underlying2(new NonstandardSwap(settings,
        ...
        ext::shared_ptr<NonstandardSwaption> swaption2 =
            ext::make_shared<NonstandardSwaption>(settings, underlying2, exercise);
        ...
        ext::shared_ptr<NonstandardSwap> underlying3(new NonstandardSwap(settings,
        ...
        ext::shared_ptr<NonstandardSwaption> swaption3 =
            ext::make_shared<NonstandardSwaption>(settings, underlying3, exercise2);
        ...
        ext::shared_ptr<FloatFloatSwap> underlying4(new FloatFloatSwap(settings,
        ...
        ext::shared_ptr<FloatFloatSwaption> swaption4 =
            ext::make_shared<FloatFloatSwaption>(settings, underlying4, exercise);

        ext::shared_ptr<Gaussian1dFloatFloatSwaptionEngine>
            floatSwaptionEngine(new Gaussian1dFloatFloatSwaptionEngine(settings,
        ...
        ext::shared_ptr<CmsCouponPricer> cmsPricer =
            ext::make_shared<LinearTsrPricer>(settings, swaptionVol, reversionQuote);
        ext::shared_ptr<IborCouponPricer> iborPricer(new BlackIborCouponPricer(settings));

        setCouponPricer(leg0, cmsPricer);
        setCouponPricer(leg1, iborPricer);

        ext::shared_ptr<PricingEngine> swapPricer =
            ext::make_shared<DiscountingSwapEngine>(settings, ytsOis);
        ...
        ext::shared_ptr<MarkovFunctional> markov =
            ext::make_shared<MarkovFunctional>(settings,
        ...
        ext::shared_ptr<Gaussian1dSwaptionEngine> swaptionEngineMarkov =
            ext::make_shared<Gaussian1dSwaptionEngine>(settings, markov, 8, 5.0, true,
                                                         false, ytsOis);
        ext::shared_ptr<Gaussian1dFloatFloatSwaptionEngine>
            floatEngineMarkov =
                ext::make_shared<Gaussian1dFloatFloatSwaptionEngine>(settings,
