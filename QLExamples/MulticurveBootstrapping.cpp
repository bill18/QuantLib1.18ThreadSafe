...
//        todaysDate = Settings::instance().evaluationDate();
        ...
        ext::shared_ptr<RateHelper> dON(new DepositRateHelper(settings,
            Handle<Quote>(dONRate),
            1 * Days, 0,
            calendar, Following,
            false, depositDayCounter));
        ext::shared_ptr<RateHelper> dTN(new DepositRateHelper(settings,
            Handle<Quote>(dTNRate),
            1 * Days, 1,
            calendar, Following,
            false, depositDayCounter));
        ext::shared_ptr<RateHelper> dSN(new DepositRateHelper(settings,
        ...
        ext::shared_ptr<Eonia> eonia(new Eonia(settings));

        ext::shared_ptr<RateHelper> ois1W(new OISRateHelper(settings,
            2, 1 * Weeks,
            Handle<Quote>(ois1WRate), eonia));
        ext::shared_ptr<RateHelper> ois2W(new OISRateHelper(settings,
            2, 2 * Weeks,
            Handle<Quote>(ois2WRate), eonia));
        ext::shared_ptr<RateHelper> ois3W(new OISRateHelper(settings,
            2, 3 * Weeks,
            Handle<Quote>(ois3WRate), eonia));
        ext::shared_ptr<RateHelper> ois1M(new OISRateHelper(settings,
            2, 1 * Months,
        ...
        ext::shared_ptr<RateHelper> oisDated1(new DatedOISRateHelper(settings,
            Date(16, January, 2013), Date(13, February, 2013),
            Handle<Quote>(oisDated1Rate), eonia));
        ext::shared_ptr<RateHelper> oisDated2(new DatedOISRateHelper(settings,
            Date(13, February, 2013), Date(13, March, 2013),
            Handle<Quote>(oisDated2Rate), eonia));
        ext::shared_ptr<RateHelper> oisDated3(new DatedOISRateHelper(settings,
            Date(13, March, 2013), Date(10, April, 2013),
            Handle<Quote>(oisDated3Rate), eonia));
        ext::shared_ptr<RateHelper> oisDated4(new DatedOISRateHelper(settings,
            Date(10, April, 2013), Date(8, May, 2013),
            Handle<Quote>(oisDated4Rate), eonia));
        ext::shared_ptr<RateHelper> oisDated5(new DatedOISRateHelper(settings,
            Date(8, May, 2013), Date(12, June, 2013),
            Handle<Quote>(oisDated5Rate), eonia));

        // OIS
        ext::shared_ptr<RateHelper> ois15M(new OISRateHelper(settings,
            2, 15*Months,
            Handle<Quote>(ois15MRate), eonia));
        ext::shared_ptr<RateHelper> ois18M(new OISRateHelper(settings,
            2, 18*Months,
            Handle<Quote>(ois18MRate), eonia));
        ext::shared_ptr<RateHelper> ois21M(new OISRateHelper(settings,
            2, 21*Months,
            Handle<Quote>(ois21MRate), eonia));
        ext::shared_ptr<RateHelper> ois2Y(new OISRateHelper(settings,
            2, 2*Years,
            Handle<Quote>(ois2YRate), eonia));
        ext::shared_ptr<RateHelper> ois3Y(new OISRateHelper(settings,
            2, 3*Years,
            Handle<Quote>(ois3YRate), eonia));
        ext::shared_ptr<RateHelper> ois4Y(new OISRateHelper(settings,
            2, 4*Years,
            Handle<Quote>(ois4YRate), eonia));
        ext::shared_ptr<RateHelper> ois5Y(new OISRateHelper(settings,
            2, 5*Years,
            Handle<Quote>(ois5YRate), eonia));
        ext::shared_ptr<RateHelper> ois6Y(new OISRateHelper(settings,
            2, 6*Years,
            Handle<Quote>(ois6YRate), eonia));
        ext::shared_ptr<RateHelper> ois7Y(new OISRateHelper(settings,
            2, 7*Years,
            Handle<Quote>(ois7YRate), eonia));
        ext::shared_ptr<RateHelper> ois8Y(new OISRateHelper(settings,
            2, 8*Years,
            Handle<Quote>(ois8YRate), eonia));
        ext::shared_ptr<RateHelper> ois9Y(new OISRateHelper(settings,
            2, 9*Years,
            Handle<Quote>(ois9YRate), eonia));
        ext::shared_ptr<RateHelper> ois10Y(new OISRateHelper(settings,
            2, 10*Years,
            Handle<Quote>(ois10YRate), eonia));
        ext::shared_ptr<RateHelper> ois11Y(new OISRateHelper(settings,
            2, 11*Years,
            Handle<Quote>(ois11YRate), eonia));
        ext::shared_ptr<RateHelper> ois12Y(new OISRateHelper(settings,
            2, 12*Years,
            Handle<Quote>(ois12YRate), eonia));
        ext::shared_ptr<RateHelper> ois15Y(new OISRateHelper(settings,
            2, 15*Years,
            Handle<Quote>(ois15YRate), eonia));
        ext::shared_ptr<RateHelper> ois20Y(new OISRateHelper(settings,
            2, 20*Years,
            Handle<Quote>(ois20YRate), eonia));
        ext::shared_ptr<RateHelper> ois25Y(new OISRateHelper(settings,
            2, 25*Years,
            Handle<Quote>(ois25YRate), eonia));
        ext::shared_ptr<RateHelper> ois30Y(new OISRateHelper(settings,
            2, 30*Years,
        ...
        **    EURIBOR 6M    **
        *********************/
        ext::shared_ptr<IborIndex> euribor6M(new Euribor6M(settings));
        ...
        ext::shared_ptr<RateHelper> d6M(new DepositRateHelper(settings,
            Handle<Quote>(d6MRate),
            6 * Months, 3,
            calendar, Following,
            false, depositDayCounter));

        ext::shared_ptr<RateHelper> fra1(new FraRateHelper(settings, Handle<Quote>(fra1Rate), 1, euribor6M));
        ext::shared_ptr<RateHelper> fra2(new FraRateHelper(settings, Handle<Quote>(fra2Rate), 2, euribor6M));
        ext::shared_ptr<RateHelper> fra3(new FraRateHelper(settings, Handle<Quote>(fra3Rate), 3, euribor6M));
        ext::shared_ptr<RateHelper> fra4(new FraRateHelper(settings, Handle<Quote>(fra4Rate), 4, euribor6M));
        ext::shared_ptr<RateHelper> fra5(new FraRateHelper(settings, Handle<Quote>(fra5Rate), 5, euribor6M));
        ext::shared_ptr<RateHelper> fra6(new FraRateHelper(settings, Handle<Quote>(fra6Rate), 6, euribor6M));
        ext::shared_ptr<RateHelper> fra7(new FraRateHelper(settings, Handle<Quote>(fra7Rate), 7, euribor6M));
        ext::shared_ptr<RateHelper> fra8(new FraRateHelper(settings, Handle<Quote>(fra8Rate), 8, euribor6M));
        ext::shared_ptr<RateHelper> fra9(new FraRateHelper(settings, Handle<Quote>(fra9Rate), 9, euribor6M));
        ext::shared_ptr<RateHelper> fra10(new FraRateHelper(settings, Handle<Quote>(fra10Rate), 10, euribor6M));
        ext::shared_ptr<RateHelper> fra11(new FraRateHelper(settings, Handle<Quote>(fra11Rate), 11, euribor6M));
        ext::shared_ptr<RateHelper> fra12(new FraRateHelper(settings, Handle<Quote>(fra12Rate), 12, euribor6M));
        ext::shared_ptr<RateHelper> fra13(new FraRateHelper(settings, Handle<Quote>(fra13Rate), 13, euribor6M));
        ext::shared_ptr<RateHelper> fra14(new FraRateHelper(settings, Handle<Quote>(fra14Rate), 14, euribor6M));
        ext::shared_ptr<RateHelper> fra15(new FraRateHelper(settings, Handle<Quote>(fra15Rate), 15, euribor6M));
        ext::shared_ptr<RateHelper> fra16(new FraRateHelper(settings, Handle<Quote>(fra16Rate), 16, euribor6M));
        ext::shared_ptr<RateHelper> fra17(new FraRateHelper(settings, Handle<Quote>(fra17Rate), 17, euribor6M));
        ext::shared_ptr<RateHelper> fra18(new FraRateHelper(settings, Handle<Quote>(fra18Rate), 18, euribor6M));
        ...
        ext::shared_ptr<IborIndex> swFloatingLegIndex(new Euribor6M(settings));

        ext::shared_ptr<RateHelper> s3y(new SwapRateHelper(settings,
        ...
        ext::shared_ptr<RateHelper> s4y(new SwapRateHelper(settings,
            Handle<Quote>(s4yRate), 
	    4 * Years,
            calendar, 
	    swFixedLegFrequency,
            swFixedLegConvention, 
        ...
        ext::shared_ptr<RateHelper> s5y(new SwapRateHelper(settings,
        ...
        ext::shared_ptr<RateHelper> s6y(new SwapRateHelper(settings,
        ...
        ext::shared_ptr<RateHelper> s7y(new SwapRateHelper(settings,
            Handle<Quote>(s7yRate), 
	    7 * Years,
            calendar, 
	    swFixedLegFrequency,
            swFixedLegConvention, 
        ...
        ext::shared_ptr<RateHelper> s8y(new SwapRateHelper(settings,
            Handle<Quote>(s8yRate), 
	    8 * Years,
            calendar, 
	    swFixedLegFrequency,
            swFixedLegConvention, 
        ...
        ext::shared_ptr<RateHelper> s9y(new SwapRateHelper(settings,
            Handle<Quote>(s9yRate), 
	    9 * Years,
            calendar, 
	    swFixedLegFrequency,
            swFixedLegConvention, 
        ...
        ext::shared_ptr<RateHelper> s10y(new SwapRateHelper(settings,
        ...
        ext::shared_ptr<RateHelper> s12y(new SwapRateHelper(settings,
            Handle<Quote>(s12yRate),
            12 * Years, 
            calendar,
            swFixedLegFrequency,
            swFixedLegConvention,
        ...
        ext::shared_ptr<RateHelper> s15y(new SwapRateHelper(settings,
        ...
        ext::shared_ptr<RateHelper> s20y(new SwapRateHelper(settings,
            Handle<Quote>(s20yRate), 
	    20 * Years,
            calendar, 
	    swFixedLegFrequency,
            swFixedLegConvention, 
        ...
        ext::shared_ptr<RateHelper> s25y(new SwapRateHelper(settings,
            Handle<Quote>(s25yRate), 
	    25 * Years,
            calendar, 
	    swFixedLegFrequency,
            swFixedLegConvention, 
        ...
        ext::shared_ptr<RateHelper> s30y(new SwapRateHelper(settings,
            Handle<Quote>(s30yRate), 
	    30 * Years,
            calendar, 
	    swFixedLegFrequency,
            swFixedLegConvention, 
        ...
        ext::shared_ptr<RateHelper> s35y(new SwapRateHelper(settings,
            Handle<Quote>(s35yRate), 
	    35 * Years,
            calendar, 
	    swFixedLegFrequency,
            swFixedLegConvention, 
        ...
        ext::shared_ptr<RateHelper> s40y(new SwapRateHelper(settings,
            Handle<Quote>(s40yRate), 
	    40 * Years,
            calendar, 
	    swFixedLegFrequency,
            swFixedLegConvention, 
        ...
        ext::shared_ptr<RateHelper> s50y(new SwapRateHelper(settings,
            Handle<Quote>(s50yRate), 
	    50 * Years,
            calendar, 
	    swFixedLegFrequency,
            swFixedLegConvention, 
        ...
        ext::shared_ptr<RateHelper> s60y(new SwapRateHelper(settings,
        ...
        ext::shared_ptr<YieldTermStructure> euribor6MTermStructure(
            new PiecewiseYieldCurve<Discount, Cubic>(settings,
        ...
        **********************/
        ...
        ext::shared_ptr<IborIndex> euriborIndex(
                                     new Euribor6M(settings, forecastingTermStructure));
        Spread spread = 0.0;
        ...
        Schedule fixedSchedule(settings->evaluationDate(), settlementDate, maturity,
                               Period(fixedLegFrequency),
                               calendar, fixedLegConvention,
                               fixedLegConvention,
                               DateGeneration::Forward, false);
        Schedule floatSchedule(settings->evaluationDate(), settlementDate, maturity,
                               Period(floatingLegFrequency),
                               calendar, floatingLegConvention,
                               floatingLegConvention,
                               DateGeneration::Forward, false);
        VanillaSwap spot5YearSwap(settings, swapType, nominal,
        ...
        Schedule fwdFixedSchedule(settings->evaluationDate(), fwdStart, fwdMaturity,
                                  Period(fixedLegFrequency),
                                  calendar, fixedLegConvention,
                                  fixedLegConvention,
                                  DateGeneration::Forward, false);
        Schedule fwdFloatSchedule(settings->evaluationDate(), fwdStart, fwdMaturity,
                                  Period(floatingLegFrequency),
                                  calendar, floatingLegConvention,
                                  floatingLegConvention,
                                  DateGeneration::Forward, false);
        VanillaSwap oneYearForward5YearSwap(settings, swapType, nominal,
        ...
        ****************/
        ...
        ext::shared_ptr<PricingEngine> swapEngine(
                         new DiscountingSwapEngine(settings, discountingTermStructure));
