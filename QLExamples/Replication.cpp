    ...
    try {
        ...
        Handle<YieldTermStructure> flatRate(
            ext::shared_ptr<YieldTermStructure>(
                                  new FlatForward(settings, 0, NullCalendar(),
                                                  h1, dayCounter)));
        Handle<BlackVolTermStructure> flatVol(
            ext::shared_ptr<BlackVolTermStructure>(
                               new BlackConstantVol(settings, 0, NullCalendar(),
                                                    h2, dayCounter)));
        ...
        ext::shared_ptr<BlackScholesProcess> bsProcess(
                            new BlackScholesProcess(settings, Handle<Quote>(underlying),
                                                    flatRate, flatVol));
        ...
        BarrierOption referenceOption(settings, barrierType, barrier, rebate,
                                      payoff, exercise);
        ...
        ext::shared_ptr<Instrument> digitalPut(
                                 new EuropeanOption(settings, digitalPayoff, exercise));
        ...
        ext::shared_ptr<Instrument> put2(
                                   new EuropeanOption(settings, lowerPayoff, exercise));
