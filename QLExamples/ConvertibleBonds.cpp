...
int main(int, char* []) {
    ...
    try {
        ...
        Schedule schedule(settings->evaluationDate(), issueDate, exerciseDate,
        ...
        for (Date d = today + 6*Months; d < exerciseDate; d += 6*Months) {
            dividends.push_back(
                      ext::shared_ptr<Dividend>(new FixedDividend(settings, 1.0, d)));
        }
        ...
        Handle<BlackVolTermStructure> flatVolTS(
            ext::shared_ptr<BlackVolTermStructure>(
                new BlackConstantVol(settings, settlementDate, calendar,
                                     volatility, dayCounter)));


        ext::shared_ptr<BlackScholesMertonProcess> stochasticProcess(
                              new BlackScholesMertonProcess(settings, underlyingH,
                                                            flatDividendTS,
                                                            flatTermStructure,
                                                            flatVolTS));
        ...
        Handle<YieldTermStructure> discountCurve(
                ext::shared_ptr<YieldTermStructure>(
                    new FlatForward(settings, today, Handle<Quote>(rate), dayCounter)));

        ext::shared_ptr<PricingEngine> engine(
                  new BinomialConvertibleEngine<JarrowRudd>(settings, stochasticProcess,
                                                            timeSteps));

        ConvertibleFixedCouponBond europeanBond(settings,
        ...
        ConvertibleFixedCouponBond americanBond(settings,
        ...
        europeanBond.setPricingEngine(ext::shared_ptr<PricingEngine>(
           new BinomialConvertibleEngine<CoxRossRubinstein>(settings, stochasticProcess,
                                                            timeSteps)));
        americanBond.setPricingEngine(ext::shared_ptr<PricingEngine>(
           new BinomialConvertibleEngine<CoxRossRubinstein>(settings, stochasticProcess,
                                                            timeSteps)));
        ...
        europeanBond.setPricingEngine(ext::shared_ptr<PricingEngine>(
                   new BinomialConvertibleEngine<AdditiveEQPBinomialTree>(settings,
                                                            stochasticProcess,
                                                            timeSteps)));
        americanBond.setPricingEngine(ext::shared_ptr<PricingEngine>(
        ...
        method = "Trigeorgis";
        europeanBond.setPricingEngine(ext::shared_ptr<PricingEngine>(
                  new BinomialConvertibleEngine<Trigeorgis>(settings, stochasticProcess,
                                                            timeSteps)));
        americanBond.setPricingEngine(ext::shared_ptr<PricingEngine>(
                  new BinomialConvertibleEngine<Trigeorgis>(settings, stochasticProcess,
                                                            timeSteps)));
        ...
        method = "Tian";
        europeanBond.setPricingEngine(ext::shared_ptr<PricingEngine>(
                        new BinomialConvertibleEngine<Tian>(settings, stochasticProcess,
                                                            timeSteps)));
        americanBond.setPricingEngine(ext::shared_ptr<PricingEngine>(
                        new BinomialConvertibleEngine<Tian>(settings, stochasticProcess,
                                                            timeSteps)));
        ...
        europeanBond.setPricingEngine(ext::shared_ptr<PricingEngine>(
                new BinomialConvertibleEngine<LeisenReimer>(settings, stochasticProcess,
                                                            timeSteps)));
        americanBond.setPricingEngine(ext::shared_ptr<PricingEngine>(
                new BinomialConvertibleEngine<LeisenReimer>(settings, stochasticProcess,
                                                            timeSteps)));
        ...
        method = "Joshi";
        europeanBond.setPricingEngine(ext::shared_ptr<PricingEngine>(
                      new BinomialConvertibleEngine<Joshi4>(settings, stochasticProcess,
                                                            timeSteps)));
        americanBond.setPricingEngine(ext::shared_ptr<PricingEngine>(
                      new BinomialConvertibleEngine<Joshi4>(settings, stochasticProcess,
                                                            timeSteps)));
