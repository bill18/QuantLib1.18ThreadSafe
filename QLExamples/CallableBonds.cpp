...
ext::shared_ptr<YieldTermStructure>
    ...
    return ext::shared_ptr<YieldTermStructure>(
                                       new FlatForward(settings, today,
...
ext::shared_ptr<YieldTermStructure>
    flatRate(Settings* settings, const Date& today,
             ...
             const Compounding &compounding,
             const Frequency &frequency) {
    return flatRate(settings, today,
...
int main(int, char* [])
{
    try {
        ...
        */
        ...
        Handle<YieldTermStructure> termStructure(flatRate(settings, today,
                                                          bbIR.rate(),
                                                          bbIR.dayCounter(),
                                                          bbIR.compounding(),
                                                          bbIR.frequency()));
        ...
        */
        ...
        Schedule sch(settings->evaluationDate(), dated, maturity, Period(frequency), bondCalendar,
        ...
        ext::shared_ptr<PricingEngine> engine0(
                      new TreeCallableFixedRateBondEngine(settings, hw0,gridIntervals));

        CallableFixedRateBond callableBond(settings, settlementDays, faceAmount, sch,
        ...
        ext::shared_ptr<PricingEngine> engine1(
                      new TreeCallableFixedRateBondEngine(settings, hw1,gridIntervals));
        ...
        ext::shared_ptr<PricingEngine> engine2(
                      new TreeCallableFixedRateBondEngine(settings, hw2,gridIntervals));
        ...
        ext::shared_ptr<PricingEngine> engine3(
                      new TreeCallableFixedRateBondEngine(settings, hw3,gridIntervals));
        ...
        ext::shared_ptr<PricingEngine> engine4(
                      new TreeCallableFixedRateBondEngine(settings, hw4,gridIntervals));
