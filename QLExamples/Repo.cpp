...
int main(int, char* []) {
    ...
    try {
        ...
        */
        ...
        Schedule bondSchedule(settings->evaluationDate(),  bondDatedDate, bondMaturityDate,
                              Period(bondCouponFrequency),
                              bondCalendar,bondBusinessDayConvention,
                              bondBusinessDayConvention,
                              DateGeneration::Backward,false);
        ext::shared_ptr<FixedRateBond> bond(
                       new FixedRateBond(settings,
                    		   	   	     bondSettlementDays,
                                         faceAmount,
                                         bondSchedule,
                                         std::vector<Rate>(1,bondCoupon),
        ...
        bond->setPricingEngine(ext::shared_ptr<PricingEngine>(
                                       new DiscountingBondEngine(settings, bondCurve)));
        ...
        FixedRateBondForward bondFwd(settings, repoSettlementDate,
                                     repoDeliveryDate,
                                     fwdType,
                                     dummyStrike,
                                     repoSettlementDays,
