...
namespace QuantLib {
    ...
    FdmBlackScholesMesher::FdmBlackScholesMesher(
        ...
        Real spotAdjustment)
    : Fdm1dMesher(size), env_(settings) {
    ...
    FdmBlackScholesMesher::processHelper(Settings* settings, const Handle<Quote>& s0,
        ...
        return ext::make_shared<GeneralizedBlackScholesProcess>(
                ...
                Handle<BlackVolTermStructure>(
                    ext::shared_ptr<BlackVolTermStructure>(
                        new BlackConstantVol(settings, rTS->referenceDate(),
                                             Calendar(),
                                             vol,
                                             rTS->dayCounter()))));
    }
