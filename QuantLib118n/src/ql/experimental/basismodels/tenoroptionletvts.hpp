...
namespace QuantLib {
    ...
    class TenorOptionletVTS : public OptionletVolatilityStructure {
      ...
      protected:
        class TenorOptionletSmileSection : public SmileSection {
          ...
          public:
            ...
            TenorOptionletSmileSection(Settings* settings, const TenorOptionletVTS& volTS, const Time optionTime);
      ...
      public:
        ...
        // constructor
        TenorOptionletVTS(Settings* settings, const Handle<OptionletVolatilityStructure>& baseVTS,
        ...
        virtual ext::shared_ptr<SmileSection> smileSectionImpl(Time optionTime) const {
            return ext::shared_ptr<SmileSection>(new TenorOptionletSmileSection(env_, *this, optionTime));
        }
