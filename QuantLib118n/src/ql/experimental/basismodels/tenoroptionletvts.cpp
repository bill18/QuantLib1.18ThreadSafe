...
namespace QuantLib {
    ...
    TenorOptionletVTS::TenorOptionletVTS(Settings* settings, const Handle<OptionletVolatilityStructure>& baseVTS,
    ...
    : OptionletVolatilityStructure(settings, baseVTS->referenceDate(),
                                   baseVTS->calendar(),
