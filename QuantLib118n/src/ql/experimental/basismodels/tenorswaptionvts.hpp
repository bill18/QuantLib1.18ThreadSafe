...
namespace QuantLib {
    ...
    class TenorSwaptionVTS : public SwaptionVolatilityStructure {
      protected:
        class TenorSwaptionSmileSection : public SmileSection {
          ...
          public:
            ...
            TenorSwaptionSmileSection(Settings* settings, const TenorSwaptionVTS& volTS,
                                      Time optionTime,
                                      Time swapLength);
      ...
      public:
        // constructor
        TenorSwaptionVTS(Settings* settings, const Handle<SwaptionVolatilityStructure>& baseVTS,
        ...
        : SwaptionVolatilityStructure(settings,
        							  baseVTS->referenceDate(),
                                      baseVTS->calendar(),
        ...
        virtual ext::shared_ptr<SmileSection> smileSectionImpl(Time optionTime,
            ...
            return ext::shared_ptr<SmileSection>(
                new TenorSwaptionSmileSection(env_, *this, optionTime, swapLength));
        }
