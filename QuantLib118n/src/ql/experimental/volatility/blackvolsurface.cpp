...
namespace QuantLib {
    ...
    BlackVolSurface::BlackVolSurface(Settings* settings, BusinessDayConvention bdc,
                                     const DayCounter& dc)
    : BlackAtmVolCurve(settings, bdc, dc) {}

    BlackVolSurface::BlackVolSurface(Settings* settings, const Date& refDate,
                                     const Calendar& cal,
                                     BusinessDayConvention bdc,
                                     const DayCounter& dc)
    : BlackAtmVolCurve(settings, refDate, cal, bdc, dc) {}

    BlackVolSurface::BlackVolSurface(Settings* settings, Natural settlDays,
                                     const Calendar& cal,
                                     BusinessDayConvention bdc,
                                     const DayCounter& dc)
    : BlackAtmVolCurve(settings, settlDays, cal, bdc, dc) {}
