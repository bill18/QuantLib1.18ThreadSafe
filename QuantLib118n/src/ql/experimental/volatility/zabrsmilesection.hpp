...
template <typename Evaluation> class ZabrSmileSection : public SmileSection {
  public:
    ZabrSmileSection(Settings* settings, Time timeToExpiry, Rate forward,
                     const std::vector<Real> &zabrParameters,
                     const std::vector<Real> &moneyness = std::vector<Real>(),
                     const Size fdRefinement = 5);
    ZabrSmileSection(Settings* settings, const Date &d, Rate forward,
                     const std::vector<Real> &zabrParameters,
...
ZabrSmileSection<Evaluation>::ZabrSmileSection(
    ...
    : SmileSection(settings, timeToExpiry, DayCounter()), forward_(forward),
...
ZabrSmileSection<Evaluation>::ZabrSmileSection(
    ...
    : SmileSection(settings, d, dc, Date()), forward_(forward), params_(zabrParams),
