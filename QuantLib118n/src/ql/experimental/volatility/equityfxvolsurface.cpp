...
namespace QuantLib {
    ...
    EquityFXVolSurface::EquityFXVolSurface(Settings* settings, BusinessDayConvention bdc,
                                           const DayCounter& dc)
    : BlackVolSurface(settings, bdc, dc) {}

    EquityFXVolSurface::EquityFXVolSurface(Settings* settings, const Date& refDate,
                                           const Calendar& cal,
                                           BusinessDayConvention bdc,
                                           const DayCounter& dc)
    : BlackVolSurface(settings, refDate, cal, bdc, dc) {}

    EquityFXVolSurface::EquityFXVolSurface(Settings* settings, Natural settlDays,
                                           const Calendar& cal,
                                           BusinessDayConvention bdc,
                                           const DayCounter& dc)
    : BlackVolSurface(settings, settlDays, cal, bdc, dc) {}
