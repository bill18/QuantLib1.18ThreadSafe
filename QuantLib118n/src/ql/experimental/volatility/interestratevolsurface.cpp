...
namespace QuantLib {
    ...
    InterestRateVolSurface::InterestRateVolSurface(
                            ...
                            const DayCounter& dc)
    : BlackVolSurface(settings, bdc, dc), index_(index) {}
    ...
    InterestRateVolSurface::InterestRateVolSurface(
                            ...
                            BusinessDayConvention bdc,
                            const DayCounter& dc)
    : BlackVolSurface(settings, refDate, cal, bdc, dc), index_(index) {}
    ...
    InterestRateVolSurface::InterestRateVolSurface(
                            ...
                            BusinessDayConvention bdc,
                            const DayCounter& dc)
    : BlackVolSurface(settings, settlDays, cal, bdc, dc), index_(index) {}
