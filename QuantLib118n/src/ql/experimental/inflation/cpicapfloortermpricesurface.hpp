...
namespace QuantLib {
    ...
    */
    class CPICapFloorTermPriceSurface : public InflationTermStructure {
      public:
        CPICapFloorTermPriceSurface(Settings* settings, Real nominal,
    ...
    class InterpolatedCPICapFloorTermPriceSurface
        : public CPICapFloorTermPriceSurface {
            public:
            InterpolatedCPICapFloorTermPriceSurface(Settings* settings, Real nominal,
                                                Rate startRate,
                                                const Period &observationLag,
                                                const Calendar &cal,
                                                const BusinessDayConvention &bdc,
    ...
    : CPICapFloorTermPriceSurface(settings, nominal, startRate, observationLag, cal, bdc, dc,
