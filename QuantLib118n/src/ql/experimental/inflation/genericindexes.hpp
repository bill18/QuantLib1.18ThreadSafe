...
namespace QuantLib {
    ...
    class GenericCPI : public ZeroInflationIndex {
      public:
        GenericCPI(Settings* settings, Frequency frequency,
                   bool revised,
                   bool interpolated,
                   const Period &lag,
                   const Currency &ccy,
        ...
        : ZeroInflationIndex(settings, "CPI",
                             GenericRegion(),
                             revised,
                             interpolated,
                             frequency,
    ...
    class YYGenericCPI : public YoYInflationIndex {
      public:
        YYGenericCPI(Settings* settings, Frequency frequency,
                     bool revised,
                     bool interpolated,
                     const Period &lag,
                     const Currency &ccy,
        ...
        : YoYInflationIndex(settings, "YY_CPI",
                            GenericRegion(),
                            revised,
                            interpolated,
                            false,
    ...
    class YYGenericCPIr : public YoYInflationIndex {
      public:
        YYGenericCPIr(Settings* settings, Frequency frequency,
                      bool revised,
                      bool interpolated,
                      const Period &lag,
                      const Currency &ccy,
                      const Handle<YoYInflationTermStructure>& ts =
                                          Handle<YoYInflationTermStructure>())
        : YoYInflationIndex(settings, "YYR_CPI",
                            GenericRegion(),
                            revised,
                            interpolated,
                            true,
