...
namespace QuantLib {
    ...
    */
    class YoYCapFloorTermPriceSurface : public InflationTermStructure {
      public:
        YoYCapFloorTermPriceSurface(Settings* settings, Natural fixingDays,
                                    const Period &yyLag,
    ...
    : YoYCapFloorTermPriceSurface(settings, fixingDays, yyLag, yii,
    ...
    calculateYoYTermStructure() const {
        ...
        for (Size i=1; i<=nYears; i++) {
            ...
            anInstrument(
                new YearOnYearInflationSwapHelper(env_,
        ...
        ext::shared_ptr<PiecewiseYoYInflationCurve<Linear> >   pYITS(
              new PiecewiseYoYInflationCurve<Linear>(env_, 
