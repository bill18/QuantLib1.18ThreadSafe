...
namespace QuantLib {
    ...
    DigitalCmsSpreadCoupon::DigitalCmsSpreadCoupon(
    		Settings* settings,
                      ...
                      bool nakedOption)
    : DigitalCoupon(settings, underlying, callStrike, callPosition, isCallATMIncluded,
    ...
    DigitalCmsSpreadLeg::DigitalCmsSpreadLeg(Settings* settings, const Schedule& schedule,
