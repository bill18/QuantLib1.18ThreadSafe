...
namespace QuantLib {
    ...
    public:
        ...
        explicit StrippedCappedFlooredCoupon(Settings* settings, const ext::shared_ptr<CappedFlooredCoupon> &underlying);
    ...
    class StrippedCappedFlooredCouponLeg {
      public:
        explicit StrippedCappedFlooredCouponLeg(Settings* settings, const Leg &underlyingLeg);
        operator Leg() const;
      private:
        Leg underlyingLeg_;
