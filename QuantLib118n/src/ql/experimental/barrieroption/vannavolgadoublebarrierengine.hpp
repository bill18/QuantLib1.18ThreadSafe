         ...
         public:
           // Constructor
             ...
             : GenericEngine<DoubleBarrierOption::arguments,
                             DoubleBarrierOption::results>(settings),
           ...
           virtual void calculate() const {
               ...
               ext::shared_ptr<BlackVolTermStructure> blackVolTS =
                   ext::make_shared<BlackConstantVol>(env_,
                                     env_->evaluationDate(),
                                     NullCalendar(), atmVolQuote, Actual365Fixed());
               ext::shared_ptr<BlackScholesMertonProcess> stochProcess =
                   ext::make_shared<BlackScholesMertonProcess>(env_,
                                       x0Quote,
                                       foreignTS_,
                                       domesticTS_,
               ...
               ext::shared_ptr<PricingEngine> engineBS =
                   ext::make_shared<DoubleBarrierEngine>(env_, stochProcess,
                                                                    series_);
