...
namespace QuantLib {
    ...
    : swapTenor_(swapTenor), overnightIndex_(overnightIndex),
      ...
      fixedDayCount_(overnightIndex->dayCounter()), env_(settings) {
    ...
    MakeArithmeticAverageOIS::operator ext::shared_ptr<ArithmeticAverageOIS>() const {
        ...
        Schedule fixedLegSchedule(env_->evaluationDate(), startDate, endDate,
        ...
        Schedule overnightLegSchedule(env_->evaluationDate(), startDate, endDate,
        ...
        if (fixedRate_ == Null<Rate>()) {
            ArithmeticAverageOIS temp(env_, type_, nominal_,
                                      fixedLegSchedule,
                                      0.0, // fixed rate
                                      fixedDayCount_,
                                      overnightIndex_,
            ...
            if (engine_ == 0) {
                ...
                ext::shared_ptr<PricingEngine> engine(new
                    DiscountingSwapEngine(env_, disc, includeSettlementDateFlows));
        ...
        ext::shared_ptr<ArithmeticAverageOIS> ois(new
            ArithmeticAverageOIS(env_, type_, nominal_,
                                 fixedLegSchedule,
    ...
    MakeArithmeticAverageOIS& MakeArithmeticAverageOIS::withDiscountingTermStructure(
        ...
        engine_ = ext::shared_ptr<PricingEngine>(new
            DiscountingSwapEngine(env_, d, includeSettlementDateFlows));
        return *this;
    }
