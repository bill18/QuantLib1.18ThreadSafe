    ...
    */
    class VarianceOption : public Instrument {
      public:
        ...
        class results;
        class engine;
        VarianceOption(Settings* settings, const ext::shared_ptr<Payoff>& payoff,
                       Real notional,
    ...
    class VarianceOption::engine :
        ...
        public:
    	   engine(Settings* settings):GenericEngine<VarianceOption::arguments,
           VarianceOption::results>(settings) {
