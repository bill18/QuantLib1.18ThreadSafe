...
namespace QuantLib {
    ...
    namespace {
        ...
        class IrregularImpliedVolHelper {
          public:
            IrregularImpliedVolHelper(Settings* settings, const IrregularSwaption&,
        ...
        : discountCurve_(discountCurve), targetValue_(targetValue) {
            ...
            engine_ = ext::shared_ptr<PricingEngine>(new
                                    BlackSwaptionEngine(settings, discountCurve_, h));
    ...
    IrregularSwaption::IrregularSwaption(Settings* settings, const ext::shared_ptr<IrregularSwap>& swap,
                                         const ext::shared_ptr<Exercise>& exercise,
                                         IrregularSettlement::Type delivery)
    : Option(ext::shared_ptr<Payoff>(), exercise), swap_(swap),
      settlementType_(delivery), env_(settings) {
        registerWith(swap_);
    }
    ...
    Volatility IrregularSwaption::impliedVolatility(
        ...
        IrregularImpliedVolHelper f(env_, *this, discountCurve, targetValue);
        //Brent solver;
        NewtonSafe solver;
