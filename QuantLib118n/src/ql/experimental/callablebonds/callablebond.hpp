...
namespace QuantLib {
    ...
    */
    class CallableBond : public Bond {
      ...
      protected:
        CallableBond(Settings* settings, Natural settlementDays,
    ...
    class CallableBond::engine
        ...
        public:
    	   engine(Settings* settings):GenericEngine<CallableBond::arguments,
           CallableBond::results>(settings) {
    ...
    */
    class CallableFixedRateBond : public CallableBond {
      public:
        CallableFixedRateBond(Settings* settings, Natural settlementDays,
                              Real faceAmount,
                              const Schedule& schedule,
    ...
    */
    class CallableZeroCouponBond : public CallableFixedRateBond {
      public:
        CallableZeroCouponBond(Settings* settings, Natural settlementDays,
                               Real faceAmount,
