...
namespace QuantLib {
    ...
    ConvertibleZeroCouponBond::ConvertibleZeroCouponBond(
    		Settings* settings,
                          ...
                          const Schedule& schedule,
                          Real redemption)
    : ConvertibleBond(settings, exercise, conversionRatio, dividends, callability,
        ...
        option_ = ext::shared_ptr<option>(
                           new option(settings, this, exercise, conversionRatio,
    ...
    : ConvertibleBond(settings, exercise, conversionRatio, dividends, callability,
        ...
        // !!! notional forcibly set to 100
        cashflows_ = IborLeg(settings, schedule, index)
    ...
    ConvertibleBond::option::option(
            ...
            Natural settlementDays,
            Real redemption)
    : OneAssetOption(settings, ext::shared_ptr<StrikedTypePayoff>(new
