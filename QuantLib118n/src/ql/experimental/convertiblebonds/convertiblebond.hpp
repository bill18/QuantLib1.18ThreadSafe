...
namespace QuantLib {
    ...
    class ConvertibleBond : public Bond {
      ...
      protected:
        ConvertibleBond(Settings* settings, const ext::shared_ptr<Exercise>& exercise,
    ...
    */
    ...
    class ConvertibleBond::option : public OneAssetOption {
      public:
        class arguments;
        class engine;
        option(Settings* settings, const ConvertibleBond* bond,
               const ext::shared_ptr<Exercise>& exercise,
               Real conversionRatio,
               const DividendSchedule& dividends,
               const CallabilitySchedule& callability,
    ...
    public:
        engine(Settings* settings):GenericEngine<ConvertibleBond::option::arguments,
                               ConvertibleBond::option::results>(settings) {
