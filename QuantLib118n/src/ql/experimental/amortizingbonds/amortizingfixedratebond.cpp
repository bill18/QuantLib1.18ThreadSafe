...
namespace QuantLib {
    ...
    : Bond(settings, settlementDays, schedule.calendar(), issueDate),
      ...
      dayCounter_(accrualDayCounter) {
        ...
        cashflows_ = FixedRateLeg(settings, schedule)
    ...
    namespace  {
        ...
        Schedule sinkingSchedule(const Date& refDate, const Date& startDate,
            ...
            Schedule retVal(refDate, startDate, maturityDate, freqPeriod,
    ...
    AmortizingFixedRateBond::AmortizingFixedRateBond(
    		Settings* settings,
                                      ...
                                      BusinessDayConvention paymentConvention,
                                      const Date& issueDate)
    : Bond(settings, settlementDays, calendar, issueDate),
      ...
      dayCounter_(accrualDayCounter) {
        ...
        cashflows_ =
            FixedRateLeg(settings, sinkingSchedule(settings->evaluationDate(), startDate, bondTenor,
