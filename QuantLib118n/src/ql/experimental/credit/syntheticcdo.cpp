...
namespace QuantLib {
    ...
    SyntheticCDO::SyntheticCDO(Settings* settings, const ext::shared_ptr<Basket>& basket,
	  ...
	  env_(settings)
    {
        ...
        normalizedLeg_ = FixedRateLeg(settings, schedule)
        ...
        Real accuracy) const 
    {
        ...
        MidPointCDOEngine engineIC(env_, discountCurve);
