    ...
    */
    class NthToDefault : public Instrument {
      public:
        ...
        //  not relevant to it.
        NthToDefault(Settings* settings, const ext::shared_ptr<Basket>& basket,
                Size n,
    ...
    class NthToDefault::engine : 
        ...
        public:
    	   engine(Settings* settings):GenericEngine<NthToDefault::arguments,
           NthToDefault::results>(settings) {
