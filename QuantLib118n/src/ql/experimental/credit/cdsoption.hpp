    ...
    */
    class CdsOption : public Option {
      public:
        ...
        class results;
        class engine;
        CdsOption(Settings* settings, const ext::shared_ptr<CreditDefaultSwap>& swap,
    ...
    class CdsOption::engine
        ...
        public:
    		engine(Settings* settings):GenericEngine<CdsOption::arguments, CdsOption::results>(settings) {
