...
namespace QuantLib {
    ...
    */
    ...
    public:
        ...
        /*! If the notional exceeds the basket inception tranche
            ...
            \todo: allow for extra payment flags, arbitrary upfront
                   payment date...
        */
        SyntheticCDO (Settings* settings, const ext::shared_ptr<Basket>& basket,
    ...
    class SyntheticCDO::engine : 
        ...
        public:
    	   engine(Settings* settings):GenericEngine<SyntheticCDO::arguments,
           SyntheticCDO::results>(settings) {
