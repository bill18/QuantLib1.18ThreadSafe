    ...
    private:
        ...
        void resetModel() {
            ...
            detachRatio_ = basket_->remainingDetachmentAmount()
             ...
             basketAttach_ = ext::make_shared<Basket>(env_, basket_->refDate(),basket_->remainingNames(),
             ...
             basketDetach_ = ext::make_shared<Basket>(env_, basket_->refDate(),basket_->remainingNames(),
                         basket_->remainingNotionals(), 
                         basket_->pool(),
                         0.0,
                         detachRatio_,
    ...
    */
        ...
        BilinearInterpolation>::setupModels() const 
    {
        ...
        scalarCorrelModelAttach_ = 
            ext::make_shared<GaussianBinomialLossModel>(env_, lmA);
        scalarCorrelModelDetach_ = 
            ext::make_shared<GaussianBinomialLossModel>(env_, lmD);
        ...
        BilinearInterpolation>::setupModels() const 
    {
        ...
        scalarCorrelModelAttach_ = 
            ext::make_shared<TBinomialLossModel>(env_, lmA);
        scalarCorrelModelDetach_ = 
            ext::make_shared<TBinomialLossModel>(env_, lmD);
