...
namespace QuantLib {
          ...
          public:
            ...
            : targetValue_(targetValue) {
                ...
                engine_ = ext::shared_ptr<PricingEngine>(
                           new BlackCdsOptionEngine(settings, probability, recoveryRate,
                                                    termStructure, h));
    ...
    CdsOption::CdsOption(Settings* settings, const ext::shared_ptr<CreditDefaultSwap>& swap,
    ...
    Volatility CdsOption::impliedVolatility(
        ...
        ImpliedVolHelper f(env_, *this, probability, recoveryRate,
