...
namespace QuantLib {
    ...
    */
    ...
    public:
        /*! The value is contingent to survival, i.e., the knockout
            ...
            \f[(1-P_{def}(T_{npv}))\f]
        */
        RiskyBond(Settings* settings, const std::string& name,
                  const Currency& ccy,
                  Real recoveryRate,
    ...
    */
    ...
    public:
        RiskyFixedBond(Settings* settings, const std::string& name,
                       const Currency& ccy,
                       Real recoveryRate,
                       const Handle<DefaultProbabilityTermStructure>& defaultTS,
    ...
    */
    ...
    public:
        RiskyFloatingBond(Settings* settings, std::string name,
                          Currency ccy,
                          Real recoveryRate,
