...
namespace QuantLib {
    ...
    public:
        ...
        CatBond(Settings* settings, Natural settlementDays,
    ...
    class CatBond::engine
        : public GenericEngine<CatBond::arguments,
                               CatBond::results> {
        public:
    	   engine(Settings* settings):GenericEngine<CatBond::arguments,
           CatBond::results>(settings) {
    ...
    */
    class FloatingCatBond : public CatBond {
      public:
        FloatingCatBond(Settings* settings, Natural settlementDays,
                         Real faceAmount,
