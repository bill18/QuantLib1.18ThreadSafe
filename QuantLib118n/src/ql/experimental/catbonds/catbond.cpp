...
namespace QuantLib {
    ...
    FloatingCatBond::FloatingCatBond(
        ...
        : CatBond(settings, settlementDays, schedule.calendar(), issueDate, notionalRisk) {

        maturityDate_ = schedule.endDate();

        cashflows_ = IborLeg(settings, schedule, iborIndex)
    ...
    FloatingCatBond::FloatingCatBond(
                           ...
                           bool endOfMonth)
    : CatBond(settings, settlementDays, calendar, issueDate, notionalRisk) {
        ...
        Schedule schedule(settings->evaluationDate(), startDate, maturityDate_, Period(couponFrequency),
