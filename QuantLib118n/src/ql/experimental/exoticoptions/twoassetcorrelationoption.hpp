...
namespace QuantLib {
    ...
    class TwoAssetCorrelationOption : public MultiAssetOption {
      public:
        class arguments;
        class engine;
        TwoAssetCorrelationOption(Settings* settings, Option::Type type,
                                  Real strike1,
                                  Real strike2,
    ...
    class TwoAssetCorrelationOption::engine
        ...
        public:
    	  engine(Settings* settings):GenericEngine<TwoAssetCorrelationOption::arguments,
          TwoAssetCorrelationOption::results>(settings) {
