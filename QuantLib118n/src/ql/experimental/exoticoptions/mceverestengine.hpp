...
namespace QuantLib {
    ...
    class MCEverestEngine : public EverestOption::engine,
      ...
      public:
        ...
        typedef typename McSimulation<MultiVariate,RNG,S>::stats_type
            stats_type;
        MCEverestEngine(Settings* settings, const ext::shared_ptr<StochasticProcessArray>&,
                        Size timeSteps,
    ...
    inline MCEverestEngine<RNG,S>::MCEverestEngine(
                   ...
                   Size maxSamples,
                   BigNatural seed)
    : EverestOption::engine(settings), McSimulation<MultiVariate,RNG,S>(antitheticVariate, false),
    ...
    ext::shared_ptr<PricingEngine>() const {
        ...
        return ext::shared_ptr<PricingEngine>(new
            MCEverestEngine<RNG,S>(env_, process_,
                                   steps_,
                                   stepsPerYear_,
                                   brownianBridge_,
                                   antithetic_,
