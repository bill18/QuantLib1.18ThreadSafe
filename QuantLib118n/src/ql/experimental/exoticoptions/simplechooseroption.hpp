    ...
    */
    class SimpleChooserOption : public OneAssetOption {
      public:
        class arguments;
        class engine;
        SimpleChooserOption(Settings* settings, Date choosingDate,
                            Real strike,
    ...
    class SimpleChooserOption::engine
       ...
       public:
    	engine(Settings* settings):GenericEngine<SimpleChooserOption::arguments,
        SimpleChooserOption::results>(settings) {
