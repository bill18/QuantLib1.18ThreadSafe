...
namespace QuantLib {
    ...
    class CompoundOption : public OneAssetOption {
      public:
        ...
        CompoundOption(Settings* settings, const ext::shared_ptr<StrikedTypePayoff>& motherPayoff,
    ...
    class CompoundOption::engine
      ...
      public:
    	engine(Settings* settings):GenericEngine<CompoundOption::arguments,
        CompoundOption::results>(settings) {
