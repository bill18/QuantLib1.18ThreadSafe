...
namespace QuantLib {
    ...
    class SpreadOption : public MultiAssetOption {
      public:
        class engine;
        SpreadOption(Settings* settings, const ext::shared_ptr<PlainVanillaPayoff>& payoff,
                     const ext::shared_ptr<Exercise>& exercise)
        : MultiAssetOption(settings, payoff, exercise) {}
    };
    ...
    class SpreadOption::engine
      ...
      public:
    	engine(Settings* settings):GenericEngine<SpreadOption::arguments,
        SpreadOption::results>(settings) {
