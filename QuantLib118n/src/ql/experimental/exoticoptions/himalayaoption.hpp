    ...
    */
    class HimalayaOption : public MultiAssetOption {
      public:
        ...
        class arguments;
        class results;
        HimalayaOption(Settings* settings, const std::vector<Date>& fixingDates,
                       Real strike);
    ...
    public:
        engine(Settings* settings):GenericEngine<HimalayaOption::arguments,
                               HimalayaOption::results>(settings) {
