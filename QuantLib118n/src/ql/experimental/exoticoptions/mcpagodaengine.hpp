...
namespace QuantLib {
    ...
    class MCPagodaEngine : public PagodaOption::engine,
      ...
      public:
        ...
        typedef typename McSimulation<MultiVariate,RNG,S>::stats_type
            stats_type;
        // constructor
        MCPagodaEngine(Settings* settings, const ext::shared_ptr<StochasticProcessArray>&,
                       bool brownianBridge,
    ...
    class MakeMCPagodaEngine {
      public:
        explicit MakeMCPagodaEngine(Settings* settings,
    ...
    inline MCPagodaEngine<RNG,S>::MCPagodaEngine(
                   ...
                   Size maxSamples,
                   BigNatural seed)
    : PagodaOption::engine(settings), McSimulation<MultiVariate,RNG,S>(antitheticVariate, false),
    ...
    ext::shared_ptr<PricingEngine>() const {
        return ext::shared_ptr<PricingEngine>(new
            MCPagodaEngine<RNG,S>(env_, process_,
                                  brownianBridge_,
                                  antithetic_,
                                  samples_, tolerance_,
                                  maxSamples_,
