...
namespace QuantLib {
    ...
    class PartialTimeBarrierOption : public OneAssetOption {
      public:
        class arguments;
        class engine;
        PartialTimeBarrierOption(Settings* settings, PartialBarrier::Type barrierType,
    ...
    class PartialTimeBarrierOption::engine
        ...
        public:
    	   engine(Settings* settings):GenericEngine<PartialTimeBarrierOption::arguments,
        PartialTimeBarrierOption::results>(settings) {
