    ...
    */
    class PagodaOption : public MultiAssetOption {
      public:
        class engine;
        class arguments;
        PagodaOption(Settings* settings, const std::vector<Date>& fixingDates,
                     Real roof,
                     Real fraction);
    ...
    public:
        engine(Settings* settings):GenericEngine<PagodaOption::arguments,
                               PagodaOption::results>(settings) {
