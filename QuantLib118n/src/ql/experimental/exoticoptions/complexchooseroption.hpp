...
namespace QuantLib{
    ...
    class ComplexChooserOption : public OneAssetOption {
      public:
        class arguments;
        class engine;
        ComplexChooserOption(Settings* settings, Date choosingDate,
                             Real strikeCall,
                             Real strikePut,
    ...
    class ComplexChooserOption::engine
        ...
        public:
    	   engine(Settings* settings):GenericEngine<ComplexChooserOption::arguments,
           ComplexChooserOption::results> (settings) {
