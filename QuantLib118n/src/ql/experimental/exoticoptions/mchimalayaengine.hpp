...
namespace QuantLib {
    ...
    class MCHimalayaEngine : public HimalayaOption::engine,
      ...
      public:
        ...
        typedef typename McSimulation<MultiVariate,RNG,S>::stats_type
            stats_type;
        MCHimalayaEngine(Settings* settings, const ext::shared_ptr<StochasticProcessArray>&,
                         bool brownianBridge,
    ...
    inline MCHimalayaEngine<RNG,S>::MCHimalayaEngine(
                   ...
                   Size maxSamples,
                   BigNatural seed)
    : HimalayaOption::engine(settings), McSimulation<MultiVariate,RNG,S>(antitheticVariate, false),
    ...
    MakeMCHimalayaEngine<RNG,S>::operator ext::shared_ptr<PricingEngine>()
        ...
        return ext::shared_ptr<PricingEngine>(new
            MCHimalayaEngine<RNG,S>(env_, process_,
                                    brownianBridge_,
                                    antithetic_,
                                    samples_,
                                    tolerance_,
