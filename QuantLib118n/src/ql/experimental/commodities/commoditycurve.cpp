...
namespace QuantLib {
    ...
    CommodityCurve::CommodityCurve(Settings* settings, const std::string& name,
    ...
    : TermStructure(settings, dates[0], calendar, dayCounter),
    ...
    CommodityCurve::CommodityCurve(Settings* settings, const std::string& name,
                                   ...
                                   const Calendar& calendar,
                                   const DayCounter& dayCounter)
    : TermStructure(settings, 0, calendar, dayCounter),
      name_(name), commodityType_(commodityType), unitOfMeasure_(unitOfMeasure),
