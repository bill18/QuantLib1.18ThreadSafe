...
namespace QuantLib {
    ...
    class SimpleCashFlow : public CashFlow {
      public:
        SimpleCashFlow(Settings* settings, Real amount,
                       const Date& date);
        //! \name Event interface
        //@{
    ...
    */
    class Redemption : public SimpleCashFlow {
      public:
        Redemption(Settings* settings, Real amount,
                   const Date& date)
        : SimpleCashFlow(settings, amount, date) {}
        //! \name Visitability
        //@{
        virtual void accept(AcyclicVisitor&);
        //@}
    ...
    */
    class AmortizingPayment : public SimpleCashFlow {
      public:
        AmortizingPayment(Settings* settings, Real amount,
                          const Date& date)
        : SimpleCashFlow(settings, amount, date) {}
        //! \name Visitability
        //@{
