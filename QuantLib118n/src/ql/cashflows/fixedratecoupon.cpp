...
namespace QuantLib {
    ...
    FixedRateCoupon::FixedRateCoupon(Settings* settings, const Date& paymentDate,
                                     Real nominal,
                                     Rate rate,
    ...
    : Coupon(settings, paymentDate, nominal, accrualStartDate, accrualEndDate,
    ...
    FixedRateLeg::FixedRateLeg(Settings* settings, const Schedule& schedule)
    ...
    FixedRateLeg::operator Leg() const {
        ...
        leg.push_back(ext::shared_ptr<CashFlow>(new
            FixedRateCoupon(env_, paymentDate, nominal, r,
        ...
        for (Size i=2; i<schedule_.size()-1; ++i) {
            ...
            leg.push_back(ext::shared_ptr<CashFlow>(new
                FixedRateCoupon(env_, paymentDate, nominal, rate,
