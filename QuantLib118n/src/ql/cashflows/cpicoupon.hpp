...
namespace QuantLib {
    ...
    */
    class CPICoupon : public InflationCoupon {
      public:
        CPICoupon(Settings* settings,Real baseCPI, // user provided, could be arbitrary
    ...
    class CPICashFlow : public IndexedCashFlow {
      public:
        CPICashFlow(Settings* settings, Real notional,
                    const ext::shared_ptr<ZeroInflationIndex>& index,
                    const Date& baseDate,
                    Real baseFixing,
        ...
        : IndexedCashFlow(settings, notional, index, baseDate, fixingDate,
    ...
    */
    class CPILeg {
      public:
        CPILeg(Settings* settings, const Schedule& schedule,
               const ext::shared_ptr<ZeroInflationIndex>& index,
               const Real baseCPI,
               const Period& observationLag);
