...
namespace QuantLib {
    ...
    class CashFlows {
    public:
        CashFlows(Settings* settings):env_(settings){
      ...
      private:
        ...
        class IrrFinder {
          public:
            IrrFinder(Settings* settings, const Leg& leg,
                      Real npv,
      ...
      public:
        ...
        static bool isExpired(Settings* settings, const Leg& leg,
                              bool includeSettlementDateFlows,
        ...
        previousCashFlow(Settings* settings, const Leg& leg,
                         bool includeSettlementDateFlows,
                         Date settlementDate = Date());
        //! the first cashflow paying after the given date
        static Leg::const_iterator
        nextCashFlow(Settings* settings, const Leg& leg,
                     bool includeSettlementDateFlows,
                     Date settlementDate = Date());
        static Date
        previousCashFlowDate(Settings* settings, const Leg& leg,
                             bool includeSettlementDateFlows,
                             Date settlementDate = Date());
        static Date
        nextCashFlowDate(Settings* settings, const Leg& leg,
                         bool includeSettlementDateFlows,
                         Date settlementDate = Date());
        static Real
        previousCashFlowAmount(Settings* settings, const Leg& leg,
                               bool includeSettlementDateFlows,
                               Date settlementDate = Date());
        static Real
        nextCashFlowAmount(Settings* settings, const Leg& leg,
                           bool includeSettlementDateFlows,
                           Date settlementDate = Date());
        //@}
        ...
        //@{
        static Rate
        previousCouponRate(Settings* settings, const Leg& leg,
                           bool includeSettlementDateFlows,
                           Date settlementDate = Date());
        static Rate
        nextCouponRate(Settings* settings, const Leg& leg,
                       bool includeSettlementDateFlows,
                       Date settlementDate = Date());

        static Real
        nominal(Settings* settings, const Leg& leg,
                bool includeSettlementDateFlows,
                Date settlDate = Date());
        static Date
        accrualStartDate(Settings* settings, const Leg& leg,
                         bool includeSettlementDateFlows,
                         Date settlDate = Date());
        static Date
        accrualEndDate(Settings* settings, const Leg& leg,
                       bool includeSettlementDateFlows,
                       Date settlementDate = Date());
        static Date
        referencePeriodStart(Settings* settings, const Leg& leg,
                             bool includeSettlementDateFlows,
                             Date settlDate = Date());
        static Date
        referencePeriodEnd(Settings* settings, const Leg& leg,
                           bool includeSettlementDateFlows,
                           Date settlDate = Date());
        static Time
        accrualPeriod(Settings* settings, const Leg& leg,
                      bool includeSettlementDateFlows,
                      Date settlementDate = Date());
        static Date::serial_type
        accrualDays(Settings* settings, const Leg& leg,
                    bool includeSettlementDateFlows,
                    Date settlementDate = Date());
        static Time
        accruedPeriod(Settings* settings, const Leg& leg,
                      bool includeSettlementDateFlows,
                      Date settlementDate = Date());
        static Date::serial_type
        accruedDays(Settings* settings, const Leg& leg,
                    bool includeSettlementDateFlows,
                    Date settlementDate = Date());
        static Real
        accruedAmount(Settings* settings, const Leg& leg,
                      bool includeSettlementDateFlows,
                      Date settlementDate = Date());
        //@}
        ...
        */
        static Real npv(Settings* settings, const Leg& leg,
        ...
        */
        static Real bps(Settings* settings, const Leg& leg,
                        const YieldTermStructure& discountCurve,
                        bool includeSettlementDateFlows,
                        Date settlementDate = Date(),
                        Date npvDate = Date());
        ...
        */
        static void npvbps(Settings* settings, const Leg& leg,
                           const YieldTermStructure& discountCurve,
                           bool includeSettlementDateFlows,
                           Date settlementDate,
                           Date npvDate,
        ...
        */
        static Rate atmRate(Settings* settings, const Leg& leg,
                            const YieldTermStructure& discountCurve,
                            bool includeSettlementDateFlows,
                            Date settlementDate = Date(),
                            Date npvDate = Date(),
        ...
        */
        static Rate yield(Settings* settings, const Leg& leg,
                          Real npv,
                          const DayCounter& dayCounter,
                          Compounding compounding,
                          Frequency frequency,
        ...
        static Rate yield(Settings* settings, const Solver& solver,
                          const Leg& leg,
                          Real npv,
                          const DayCounter& dayCounter,
                          Compounding compounding,
                          ...
                          Real accuracy = 1.0e-10,
                          Rate guess = 0.05) {
            IrrFinder objFunction(settings, leg, npv, dayCounter, compounding,
        ...
        /*! The simple duration of a string of cash flows is defined as
            ...
            cash flows per year.
        */
        static Time duration(Settings* settings, const Leg& leg,
                             const InterestRate& yield,
                             Duration::Type type,
                             bool includeSettlementDateFlows,
                             Date settlementDate = Date(),
        ...
        /*! The convexity of a string of cash flows is defined as
            ...
            according to the given IRR \f$ y \f$.
        */
        static Real convexity(Settings* settings, const Leg& leg,
                              const InterestRate& yield,
                              bool includeSettlementDateFlows,
                              Date settlementDate = Date(),
                              Date npvDate = Date());
        ...
        /*! Obtained by setting dy = 0.0001 in the 2nd-order Taylor
            series expansion.
        */
        static Real basisPointValue(Settings* settings, const Leg& leg,
                                    const InterestRate& yield,
                                    bool includeSettlementDateFlows,
                                    Date settlementDate = Date(),
                                    Date npvDate = Date());
        ...
        /*! The yield value of a one basis point change in price is
            ...
            multiplied by 0.01
        */
        static Real yieldValueBasisPoint(Settings* settings, const Leg& leg,
                                         const InterestRate& yield,
                                         bool includeSettlementDateFlows,
                                         Date settlementDate = Date(),
                                         Date npvDate = Date());
        ...
        */
        static Real npv(Settings* settings, const Leg& leg,
                        ...
                        Date npvDate = Date());
        //! implied Z-spread.
        static Spread zSpread(Settings* settings, const Leg& leg,
                              Real npv,
        ...
        static Spread zSpread(Settings* settings, const Leg& leg,
                              ...
                              Size maxIterations = 100,
                              Rate guess = 0.0) {
            return zSpread(settings, leg, npv, d, dayCounter, compounding, frequency,
