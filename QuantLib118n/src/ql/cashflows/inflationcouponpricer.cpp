...
namespace QuantLib {
    ...
    YoYInflationCouponPricer::YoYInflationCouponPricer(Settings* settings):env_(settings) {}

    YoYInflationCouponPricer::YoYInflationCouponPricer(Settings* settings,
    ...
    Real YoYInflationCouponPricer::optionletRate(Option::Type optionType,
        ...
        if (fixingDate <= env_->evaluationDate()) {
