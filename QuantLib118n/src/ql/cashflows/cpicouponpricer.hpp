...
namespace QuantLib {
    ...
    */
    class CPICouponPricer : public InflationCouponPricer {
      public:
        CPICouponPricer(Settings* settings);
        /*! \deprecated Use the constructor also taking an explicit
                        nominal term structure.
                        Deprecated in version 1.15.
        */
        QL_DEPRECATED
        explicit CPICouponPricer(Settings* settings, const Handle<CPIVolatilitySurface>& capletVol);
        CPICouponPricer(Settings* settings, const Handle<CPIVolatilitySurface>& capletVol,
