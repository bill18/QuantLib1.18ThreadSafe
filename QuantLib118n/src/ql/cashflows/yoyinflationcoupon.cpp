...
namespace QuantLib {
    ...
    YoYInflationCoupon::
    YoYInflationCoupon(Settings* settings,
    ...
    yoyInflationLeg::
    yoyInflationLeg(Settings* settings, const Schedule& schedule, const Calendar& paymentCalendar,
        ...
        for (Size i=0; i<n; ++i) {
            ...
            if (detail::get(gearings_, i, 1.0) == 0.0) { // fixed coupon
                leg.push_back(ext::shared_ptr<CashFlow>(new
                            FixedRateCoupon(env_, paymentDate,
                ...
                if (detail::noOption(caps_, floors_, i)) { // just swaplet
                    ...
                    ext::shared_ptr<YoYInflationCouponPricer> pricer(
                                            new YoYInflationCouponPricer(env_));
