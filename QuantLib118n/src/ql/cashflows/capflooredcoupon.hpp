    ...
    */
    ...
    class CappedFlooredIborCoupon : public CappedFlooredCoupon {
      public:
        ...
        : CappedFlooredCoupon(settings, ext::shared_ptr<FloatingRateCoupon>(new
            IborCoupon(settings, paymentDate, nominal, startDate, endDate, fixingDays,
      ...
      public:
        CappedFlooredCmsCoupon(
        		Settings* settings,
                  ...
                  const Date& exCouponDate = Date())
        : CappedFlooredCoupon(settings, ext::shared_ptr<FloatingRateCoupon>(new
            CmsCoupon(settings, paymentDate, nominal, startDate, endDate, fixingDays,
                      index, gearing, spread, refPeriodStart, refPeriodEnd,
                      dayCounter, isInArrears, exCouponDate)), cap, floor) {
        }
