...
namespace QuantLib {
    ...
    AverageBMACoupon::AverageBMACoupon(Settings* settings,
    ...
    AverageBMALeg::AverageBMALeg(Settings* settings, const Schedule& schedule,
                                 const ext::shared_ptr<BMAIndex>& index)
    ...
    AverageBMALeg::operator Leg() const {
        ...
        for (Size i=0; i<n; ++i) {
            ...
            cashflows.push_back(ext::shared_ptr<CashFlow>(new
                AverageBMACoupon(env_, paymentDate,
