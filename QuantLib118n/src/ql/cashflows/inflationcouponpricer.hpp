...
namespace QuantLib {
    ...
    */
    ...
    class BlackYoYInflationCouponPricer : public YoYInflationCouponPricer {
      public:
        BlackYoYInflationCouponPricer(Settings* settings):YoYInflationCouponPricer(settings) {}
        /*! \deprecated Use the constructor also taking an explicit
                        nominal term structure.
                        Deprecated in version 1.15.
        */
        QL_DEPRECATED
        explicit BlackYoYInflationCouponPricer(Settings* settings,
            const Handle<YoYOptionletVolatilitySurface>& capletVol)
        : YoYInflationCouponPricer(settings, capletVol, Handle<YieldTermStructure>()) {}
        BlackYoYInflationCouponPricer(Settings* settings,
            const Handle<YoYOptionletVolatilitySurface>& capletVol,
            const Handle<YieldTermStructure>& nominalTermStructure)
        : YoYInflationCouponPricer(settings, capletVol, nominalTermStructure) {}
      protected:
    ...
    class UnitDisplacedBlackYoYInflationCouponPricer : public YoYInflationCouponPricer {
      public:
        UnitDisplacedBlackYoYInflationCouponPricer(Settings* settings):YoYInflationCouponPricer(settings) {}
        /*! \deprecated Use the constructor also taking an explicit
                        nominal term structure.
                        Deprecated in version 1.15.
        */
        QL_DEPRECATED
        explicit UnitDisplacedBlackYoYInflationCouponPricer(Settings* settings,
            const Handle<YoYOptionletVolatilitySurface>& capletVol)
        : YoYInflationCouponPricer(settings, capletVol, Handle<YieldTermStructure>()) {}
        UnitDisplacedBlackYoYInflationCouponPricer(Settings* settings,
            const Handle<YoYOptionletVolatilitySurface>& capletVol,
            const Handle<YieldTermStructure>& nominalTermStructure)
        : YoYInflationCouponPricer(settings, capletVol, nominalTermStructure) {}
      protected:
    ...
    class BachelierYoYInflationCouponPricer : public YoYInflationCouponPricer {
      public:
        BachelierYoYInflationCouponPricer(Settings* settings):YoYInflationCouponPricer(settings) {}
        /*! \deprecated Use the constructor also taking an explicit
                        nominal term structure.
                        Deprecated in version 1.15.
        */
        QL_DEPRECATED
        explicit BachelierYoYInflationCouponPricer(Settings* settings,
            const Handle<YoYOptionletVolatilitySurface>& capletVol)
        : YoYInflationCouponPricer(settings, capletVol, Handle<YieldTermStructure>()) {}
        BachelierYoYInflationCouponPricer(Settings* settings,
            const Handle<YoYOptionletVolatilitySurface>& capletVol,
            const Handle<YieldTermStructure>& nominalTermStructure)
        : YoYInflationCouponPricer(settings, capletVol, nominalTermStructure) {}
      protected:
