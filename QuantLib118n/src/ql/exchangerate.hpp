...
namespace QuantLib {
    ...
    */
    ...
    inline ExchangeRate::ExchangeRate(Date evalDate)
    : rate_(Null<Decimal>()), evalDate_(evalDate) {}

    inline ExchangeRate::ExchangeRate(Date evalDate, const Currency& source,
                                      const Currency& target,
                                      Decimal rate)
    : source_(source), target_(target), rate_(rate), type_(Direct), evalDate_(evalDate) {}
