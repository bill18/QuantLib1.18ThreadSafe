...
namespace QuantLib {
    ...
    BatesModel::BatesModel(Settings* settings, const ext::shared_ptr<BatesProcess> & process)
    : HestonModel(settings, process) {
        arguments_.resize(8);
    ...
    : BatesDoubleExpModel(settings, process, lambda, nuUp, nuDown, p) {
