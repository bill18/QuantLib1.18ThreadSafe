...
namespace QuantLib {
    ...
    HestonModel::HestonModel(Settings* settings, const ext::shared_ptr<HestonProcess> & process)
    : CalibratedModel(5), process_(process), env_(settings) {
    ...
    void HestonModel::generateArguments() {
        process_.reset(new HestonProcess(env_, process_->riskFreeRate(),
