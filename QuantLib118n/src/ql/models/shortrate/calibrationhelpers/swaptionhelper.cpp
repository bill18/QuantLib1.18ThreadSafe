...
namespace QuantLib {
    ...
    void SwaptionHelper::performCalculations() const {
        ...
        Schedule fixedSchedule(env_->evaluationDate(), startDate, endDate, fixedLegTenor_, calendar,
                               index_->businessDayConvention(),
                               index_->businessDayConvention(),
                               DateGeneration::Forward, false);
        Schedule floatSchedule(env_->evaluationDate(), startDate, endDate, index_->tenor(), calendar,
                               index_->businessDayConvention(),
                               index_->businessDayConvention(),
                               DateGeneration::Forward, false);
        ...
        VanillaSwap temp(env_, VanillaSwap::Receiver, nominal_,
        ...
        swaption_ = ext::make_shared<Swaption>(env_, swap_, exercise);
