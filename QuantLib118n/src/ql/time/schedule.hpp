...
namespace QuantLib {
    ...
    class Schedule {
      public:
        ...
        Schedule(Date evalDate, Date effectiveDate,
...
//        Schedule(Settings* settings):env_(settings) {}
        Schedule() {}
        //! \name Date access
        //@{
        ...
        const_iterator lower_bound(const Date& d) const;
        //@}
        //! \name Utilities
        //@{
        //! truncated schedule
...
//        Settings* env_;
    ...
    */
    class MakeSchedule {
      public:
        MakeSchedule(const Date& evalDate);
