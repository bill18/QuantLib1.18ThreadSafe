...
namespace QuantLib {
    ...
    TermStructure::TermStructure(Settings* settings, const DayCounter& dc)
    : moving_(false),
      updated_(true),
      settlementDays_(Null<Natural>()),
      dayCounter_(dc), env_(settings) {}

    TermStructure::TermStructure(Settings* settings, const Date& referenceDate,
                                 const Calendar& cal,
                                 const DayCounter& dc)
    ...
    TermStructure::TermStructure(Settings* settings, Natural settlementDays,
                                 const Calendar& cal,
                                 const DayCounter& dc)
