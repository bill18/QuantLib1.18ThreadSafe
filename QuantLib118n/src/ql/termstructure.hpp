...
namespace QuantLib {
    ...
    class TermStructure : public virtual Observer,
      ...
      public:
        ...
        */
        explicit TermStructure(Settings* settings, const DayCounter& dc = DayCounter());
        //! initialize with a fixed reference date
        explicit TermStructure(Settings* settings, const Date& referenceDate,
                               const Calendar& calendar = Calendar(),
                               const DayCounter& dc = DayCounter());
        //! calculate the reference date based on the global evaluation date
        TermStructure(Settings* settings,Natural settlementDays,
                      const Calendar&,
                      const DayCounter& dc = DayCounter());
        //@}
