...
namespace QuantLib {
    ...
    */
    ...
    class DiscreteAveragingAsianOption::engine
	   ...
	   public:
		engine(Settings* settings): GenericEngine<DiscreteAveragingAsianOption::arguments,
		DiscreteAveragingAsianOption::results> (settings) {
    ...
    class ContinuousAveragingAsianOption::engine
        ...
        public:
    		engine(Settings* settings): GenericEngine<ContinuousAveragingAsianOption::arguments,
            ContinuousAveragingAsianOption::results> (settings) {
