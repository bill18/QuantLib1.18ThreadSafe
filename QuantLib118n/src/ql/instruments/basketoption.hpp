...
namespace QuantLib {
    ...
    class BasketOption : public MultiAssetOption {
      public:
        class engine;
        BasketOption(Settings* settings, const ext::shared_ptr<BasketPayoff>&,
    ...
    class BasketOption::engine
        ...
        public:
    	engine(Settings* settings):GenericEngine<BasketOption::arguments,
        BasketOption::results>(settings) {
