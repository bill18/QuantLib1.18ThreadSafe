...
namespace QuantLib {
    ...
    */
      ...
      public:
        ...
        /*! @param side  Whether the protection is bought or sold.
            ...
            @param rebatesAccrual  The protection seller pays the accrued 
                                    ...
                                    protection start.
        */
        CreditDefaultSwap(Settings* settings, Protection::Side side,
                          Real notional,
                          Rate spread,
    ...
    class CreditDefaultSwap::engine
        ...
        public:
    	engine(Settings* settings):GenericEngine<CreditDefaultSwap::arguments,
        CreditDefaultSwap::results>(settings) {
