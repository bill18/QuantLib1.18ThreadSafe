...
namespace QuantLib {
    ...
    */
    class MakeCreditDefaultSwap {
      public:
        MakeCreditDefaultSwap(Settings* settings, const Period &tenor, const Real couponRate);
        MakeCreditDefaultSwap(Settings* settings, const Date &termDate, const Real couponRate);
