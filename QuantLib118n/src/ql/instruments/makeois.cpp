...
namespace QuantLib {
    ...
    MakeOIS::MakeOIS(Settings* settings, const Period& swapTenor,
    ...
    MakeOIS::operator ext::shared_ptr<OvernightIndexedSwap>() const {
        ...
        Schedule schedule(env_->evaluationDate(), startDate, endDate,
        ...
        if (fixedRate_ == Null<Rate>()) {
            OvernightIndexedSwap temp(env_, type_, nominal_,
                                      schedule,
                                      0.0, // fixed rate
                                      fixedDayCount_,
        ...
        ext::shared_ptr<OvernightIndexedSwap> ois(new
            OvernightIndexedSwap(env_, type_, nominal_,
                                 schedule,
