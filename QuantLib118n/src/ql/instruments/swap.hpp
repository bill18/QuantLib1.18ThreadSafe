...
namespace QuantLib {
    ...
    */
    class Swap : public Instrument {
      public:
        ...
        /*! The cash flows belonging to the first leg are paid;
            the ones belonging to the second leg are received.
        */
        Swap(Settings* settings, const Leg& firstLeg,
             const Leg& secondLeg);
        /*! Multi leg constructor. */
        Swap(Settings* settings, const std::vector<Leg>& legs,
      ...
      protected:
        ...
        */
        Swap(Settings* settings, Size legs);
        //@}
        //! \name Instrument interface
        //@{
    ...
    class Swap::engine : public GenericEngine<Swap::arguments,
                                              Swap::results> {
        public:
    		explicit engine(Settings* settings):GenericEngine<Swap::arguments,
            Swap::results>(settings) {
