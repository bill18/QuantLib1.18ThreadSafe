...
namespace QuantLib {
    ...
    class YoYInflationCapFloor : public Instrument {
      public:
        ...
        class arguments;
        class engine;
        YoYInflationCapFloor(Settings* settings, Type type,
                 const Leg& yoyLeg,
    ...
    class YoYInflationCap : public YoYInflationCapFloor {
      public:
        YoYInflationCap(Settings* settings, const Leg& yoyLeg,
            const std::vector<Rate>& exerciseRates)
        : YoYInflationCapFloor(settings, YoYInflationCapFloor::Cap, yoyLeg,
    ...
    class YoYInflationFloor : public YoYInflationCapFloor {
      public:
        YoYInflationFloor(Settings* settings, const Leg& yoyLeg,
              const std::vector<Rate>& exerciseRates)
        : YoYInflationCapFloor(settings, YoYInflationCapFloor::Floor, yoyLeg,
    ...
    class YoYInflationCollar : public YoYInflationCapFloor {
      public:
        YoYInflationCollar(Settings* settings, const Leg& yoyLeg,
               const std::vector<Rate>& capRates,
               const std::vector<Rate>& floorRates)
        : YoYInflationCapFloor(settings, YoYInflationCapFloor::Collar, yoyLeg,
                               capRates, floorRates) {}
    };
    ...
    : public GenericEngine<YoYInflationCapFloor::arguments,
        ...
        public:
    		engine(Settings* settings):GenericEngine<YoYInflationCapFloor::arguments,
            YoYInflationCapFloor::results> (settings) {
