...
namespace QuantLib {
    ...
    YoYInflationCapFloor::YoYInflationCapFloor(Settings* settings, YoYInflationCapFloor::Type type,
                       const Leg& yoyLeg,
    ...
    : type_(type), yoyLeg_(yoyLeg), env_(settings) {
    ...
    ext::shared_ptr<YoYInflationCapFloor> YoYInflationCapFloor::optionlet(const Size i) const {
        ...
        return ext::make_shared<YoYInflationCapFloor>(env_, type(),
                                                    cf, cap, floor);
    }
    ...
    Rate YoYInflationCapFloor::atmRate(const YieldTermStructure& discountCurve) const {
        return CashFlows::atmRate(env_, yoyLeg_, discountCurve,
