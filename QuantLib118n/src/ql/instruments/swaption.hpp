    ...
    */
    class Swaption : public Option {
      public:
        class arguments;
        class engine;
        Swaption(Settings* settings, const ext::shared_ptr<VanillaSwap>& swap,
                 const ext::shared_ptr<Exercise>& exercise,
                 Settlement::Type delivery = Settlement::Physical,
                 Settlement::Method settlementMethod = Settlement::PhysicalOTC);
// ?????
//        Swaption& operator=(const Swaption& other) {
//            this->swap_= other.swap_;
//            this->settlementType_ = other.settlementType_;
//            this->settlementMethod_= other.settlementMethod_;
...
//        } 
    ...
    class Swaption::engine
        ...
        public:
    	   engine(Settings* settings):GenericEngine<Swaption::arguments, Swaption::results>(settings) {}
    };
