...
namespace QuantLib {
    ...
    FixedRateBond::FixedRateBond(Settings* settings, Natural settlementDays,
                                 Real faceAmount,
    ...
    FixedRateBond::FixedRateBond(Settings* settings, Natural settlementDays,
     ...
     : Bond(settings, settlementDays,
      ...
      frequency_(tenor.frequency()), dayCounter_(accrualDayCounter) {
        ...
        Schedule schedule(env_->evaluationDate(), startDate, maturityDate_, tenor,
