...
namespace QuantLib {
    ...
    */
    class CCTEU : public FloatingRateBond {
      public:
        CCTEU(Settings* settings, const Date& maturityDate,
              Spread spread,
    ...
    */
    class BTP : public FixedRateBond {
      public:
        BTP(Settings* settings, const Date& maturityDate,
            Rate fixedRate,
            const Date& startDate = Date(),
            const Date& issueDate = Date());
    ...
    class RendistatoCalculator : public LazyObject {
      public:
        RendistatoCalculator(Settings* settings, const ext::shared_ptr<RendistatoBasket>& basket,
