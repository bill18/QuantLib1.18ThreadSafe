    ...
    */
    class CliquetOption : public OneAssetOption {
      public:
        class arguments;
        class engine;
        CliquetOption(Settings* settings, const ext::shared_ptr<PercentageStrikePayoff>&,
    ...
    class CliquetOption::engine
        ...
        public:
    	   engine(Settings* settings):GenericEngine<CliquetOption::arguments,
           CliquetOption::results>(settings) {
