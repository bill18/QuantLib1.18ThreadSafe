...
namespace QuantLib {
    ...
    */
    ...
    class ContinuousFloatingLookbackOption::engine
       ...
       public:
    	engine(Settings* settings):GenericEngine<ContinuousFloatingLookbackOption::arguments,
        ContinuousFloatingLookbackOption::results>(settings) {
    ...
    class ContinuousFixedLookbackOption::engine
	   ...
	   public:
			engine(Settings* settings):GenericEngine<ContinuousFixedLookbackOption::arguments,
			ContinuousFixedLookbackOption::results>(settings) {
    ...
    class ContinuousPartialFloatingLookbackOption::engine
	   ...
	   public:
			engine(Settings* settings):GenericEngine<ContinuousPartialFloatingLookbackOption::arguments,
			ContinuousPartialFloatingLookbackOption::results>(settings) {
    ...
    class ContinuousPartialFixedLookbackOption::engine
	   ...
	   public:
			engine(Settings* settings):GenericEngine<ContinuousPartialFixedLookbackOption::arguments,
			ContinuousPartialFixedLookbackOption::results>(settings) {
