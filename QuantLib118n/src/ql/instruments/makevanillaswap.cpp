...
namespace QuantLib {
    ...
    MakeVanillaSwap::MakeVanillaSwap(Settings* settings, const Period& swapTenor,
    ...
    MakeVanillaSwap::operator ext::shared_ptr<VanillaSwap>() const {
        ...
        Schedule fixedSchedule(env_->evaluationDate(), startDate, endDate,
        ...
        Schedule floatSchedule(env_->evaluationDate(), startDate, endDate,
        ...
        if (fixedRate_ == Null<Rate>()) {
            VanillaSwap temp(env_, type_, nominal_,
                             fixedSchedule,
                             0.0, // fixed rate
                             fixedDayCount,
        ...
        ext::shared_ptr<VanillaSwap> swap(new
            VanillaSwap(env_, type_, nominal_,
                        fixedSchedule,
