...
namespace QuantLib {
    ...
    MakeSwaption::MakeSwaption(Settings* settings, const ext::shared_ptr<SwapIndex>& swapIndex,
    ...
    : swapIndex_(swapIndex),
      ...
      strike_(strike),
      underlyingType_(VanillaSwap::Payer), env_(settings) {
    ...
    MakeSwaption::operator ext::shared_ptr<Swaption>() const {
        ...
        underlyingSwap_ =
            MakeVanillaSwap(env_, swapIndex_->tenor(),
        ...
        ext::shared_ptr<Swaption> swaption(new Swaption(env_,
