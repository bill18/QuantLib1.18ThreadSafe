    ...
    */
    ...
    class Cap : public CapFloor {
      public:
        ...
        : CapFloor(settings, CapFloor::Cap, floatingLeg,
    ...
    class Floor : public CapFloor {
      public:
        Floor(Settings* settings, const Leg& floatingLeg,
              const std::vector<Rate>& exerciseRates)
        : CapFloor(settings, CapFloor::Floor, floatingLeg,
    ...
    class Collar : public CapFloor {
      public:
        Collar(Settings* settings,const Leg& floatingLeg,
               const std::vector<Rate>& capRates,
               const std::vector<Rate>& floorRates)
        : CapFloor(settings, CapFloor::Collar, floatingLeg, capRates, floorRates) {}
    };
    ...
    class CapFloor::engine
        ...
        public:
    	    engine(Settings* settings):GenericEngine<CapFloor::arguments, CapFloor::results>(settings) {
