...
namespace QuantLib {
    ...
    class InterpolatedZeroInflationCurve
      ...
      public:
        InterpolatedZeroInflationCurve(Settings* settings, const Date& referenceDate,
    ...
    InterpolatedZeroInflationCurve(Settings* settings, const Date& referenceDate,
                                   ...
                                   const std::vector<Rate>& rates,
                                   const Interpolator& interpolator)
    : ZeroInflationTermStructure(settings, referenceDate, calendar, dayCounter, rates[0],
    ...
    InterpolatedZeroInflationCurve(Settings* settings, const Date& referenceDate,
                                   ...
                                   const Handle<YieldTermStructure>& yTS,
                                   const Interpolator& interpolator)
    :  ZeroInflationTermStructure(settings, referenceDate, calendar, dayCounter, baseZeroRate,
                                  lag, frequency, indexIsInterpolated, yTS),
