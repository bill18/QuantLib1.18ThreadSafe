...
namespace QuantLib {
    ...
    */
    ...
    class InterpolatedYoYInflationCurve
      ...
      public:
        InterpolatedYoYInflationCurve(Settings* settings, const Date& referenceDate,
    ...
    InterpolatedYoYInflationCurve(Settings* settings, const Date& referenceDate,
                                  ...
                                  const std::vector<Rate>& rates,
                                  const Interpolator& interpolator)
    : YoYInflationTermStructure(settings, referenceDate, calendar, dayCounter, rates[0],
    ...
    InterpolatedYoYInflationCurve(Settings* settings, const Date& referenceDate,
                                  ...
                                  const Handle<YieldTermStructure>& yTS,
                                  const Interpolator& interpolator)
    : YoYInflationTermStructure(settings, referenceDate, calendar, dayCounter, baseYoYRate,
                                lag, frequency, indexIsInterpolated, yTS),
