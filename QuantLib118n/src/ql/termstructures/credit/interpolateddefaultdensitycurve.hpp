...
namespace QuantLib {
    ...
    : DefaultDensityStructure(settings, dayCounter, jumps, jumpDates),
    ...
    InterpolatedDefaultDensityCurve<T>::InterpolatedDefaultDensityCurve(
                                    ...
                                    const std::vector<Date>& jumpDates,
                                    const T& interpolator)
    : DefaultDensityStructure(settings, referenceDate, Calendar(), dayCounter, jumps, jumpDates),
      InterpolatedCurve<T>(interpolator) {}
    ...
    InterpolatedDefaultDensityCurve<T>::InterpolatedDefaultDensityCurve(
                                    ...
                                    const std::vector<Date>& jumpDates,
                                    const T& interpolator)
    : DefaultDensityStructure(settings, settlementDays, calendar, dayCounter, jumps, jumpDates),
      InterpolatedCurve<T>(interpolator) {}
    ...
    InterpolatedDefaultDensityCurve<T>::InterpolatedDefaultDensityCurve(
                                    ...
                                    const std::vector<Date>& jumpDates,
                                    const T& interpolator)
    : DefaultDensityStructure(settings, dates.at(0), calendar, dayCounter, jumps, jumpDates),
    ...
    InterpolatedDefaultDensityCurve<T>::InterpolatedDefaultDensityCurve(
                                    ...
                                    const Calendar& calendar,
                                    const T& interpolator)
    : DefaultDensityStructure(settings, dates.at(0), calendar, dayCounter),
      InterpolatedCurve<T>(std::vector<Time>(), densities, interpolator),
      dates_(dates)
    {
        initialize(dates, densities, dayCounter);
