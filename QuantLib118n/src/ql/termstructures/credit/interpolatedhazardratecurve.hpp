...
namespace QuantLib {
    ...
    : HazardRateStructure(settings, dayCounter, jumps, jumpDates),
    ...
    InterpolatedHazardRateCurve<T>::InterpolatedHazardRateCurve(
                                    ...
                                    const std::vector<Date>& jumpDates,
                                    const T& interpolator)
    : HazardRateStructure(settings, referenceDate, Calendar(), dayCounter, jumps, jumpDates),
      InterpolatedCurve<T>(interpolator) {}
    ...
    InterpolatedHazardRateCurve<T>::InterpolatedHazardRateCurve(
                                    ...
                                    const std::vector<Date>& jumpDates,
                                    const T& interpolator)
    : HazardRateStructure(settings, settlementDays, calendar, dayCounter, jumps, jumpDates),
      InterpolatedCurve<T>(interpolator) {}
    ...
    InterpolatedHazardRateCurve<T>::InterpolatedHazardRateCurve(
                                    ...
                                    const std::vector<Date>& jumpDates,
                                    const T& interpolator)
    : HazardRateStructure(settings, dates.at(0), calendar, dayCounter, jumps, jumpDates),
    ...
    InterpolatedHazardRateCurve<T>::InterpolatedHazardRateCurve(
            ...
            const Calendar& calendar,
            const T& interpolator)
    : HazardRateStructure(settings, dates.at(0), calendar, dayCounter),
      InterpolatedCurve<T>(std::vector<Time>(), hazardRates, interpolator),
      dates_(dates)
    {
        initialize();
