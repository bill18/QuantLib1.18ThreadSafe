...
namespace QuantLib {
    ...
    : DefaultProbabilityTermStructure(settings, dc, jumps, jumpDates) {}
    ...
    DefaultDensityStructure::DefaultDensityStructure(
                                    ...
                                    const std::vector<Handle<Quote> >& jumps,
                                    const std::vector<Date>& jumpDates)
    : DefaultProbabilityTermStructure(settings, refDate, cal, dc, jumps, jumpDates) {}
    ...
    DefaultDensityStructure::DefaultDensityStructure(
    		Settings* settings,
                                    ...
                                    const std::vector<Handle<Quote> >& jumps,
                                    const std::vector<Date>& jumpDates)
    : DefaultProbabilityTermStructure(settings, settlDays, cal, dc, jumps, jumpDates) {}
