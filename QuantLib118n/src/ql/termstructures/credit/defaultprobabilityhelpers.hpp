...
namespace QuantLib {
    ...
    */
    class CdsHelper : public RelativeDateDefaultProbabilityHelper {
      public:
        CdsHelper(Settings* settings,const Handle<Quote>& quote,
                  const Period& tenor,
        ...
        CdsHelper(Settings* settings, Rate quote,
                  const Period& tenor,
                  Integer settlementDays,
                  const Calendar& calendar,
                  Frequency frequency,
    ...
    class SpreadCdsHelper : public CdsHelper {
      public:
        SpreadCdsHelper(Settings* settings, const Handle<Quote>& runningSpread,
                        const Period& tenor,
                        Integer settlementDays,
                        const Calendar& calendar,
                        Frequency frequency,
        ...
        SpreadCdsHelper(Settings* settings, Rate runningSpread,
                        const Period& tenor,
    ...
    class UpfrontCdsHelper : public CdsHelper {
      public:
        ...
        UpfrontCdsHelper(Settings* settings, const Handle<Quote>& upfront,
                         Rate runningSpread,
                         const Period& tenor,
                         Integer settlementDays,
                         const Calendar& calendar,
        ...
        /*! \note the upfront must be quoted in fractional units. */
        UpfrontCdsHelper(Settings* settings, Rate upfront,
                         Rate runningSpread,
                         const Period& tenor,
                         Integer settlementDays,
                         const Calendar& calendar,
