    ...
    */
    ...
    class PiecewiseDefaultCurve
      ...
      public:
        ...
        : base_curve(settings, referenceDate, dayCounter, jumps, jumpDates, i),
        ...
        PiecewiseDefaultCurve(
               ...
               const bootstrap_type& bootstrap = bootstrap_type())
        : base_curve(settings, referenceDate, dayCounter,
        ...
        */
        ...
        PiecewiseDefaultCurve(
               ...
               const Interpolator& i = Interpolator(),
               const bootstrap_type& bootstrap = bootstrap_type())
        : base_curve(settings, settlementDays, calendar, dayCounter, jumps, jumpDates, i),
          instruments_(instruments), accuracy_(1.0e-12), bootstrap_(bootstrap) {
            bootstrap_.setup(this);
        }
        PiecewiseDefaultCurve(
               ...
               const Interpolator& i,
               const bootstrap_type& bootstrap = bootstrap_type())
        : base_curve(settings, settlementDays, calendar, dayCounter,
                     std::vector<Handle<Quote> >(), std::vector<Date>(), i),
          instruments_(instruments), accuracy_(1.0e-12), bootstrap_(bootstrap) {
            bootstrap_.setup(this);
        }
        ...
        */
        PiecewiseDefaultCurve(
            ...
            const Interpolator& i = Interpolator(),
            const bootstrap_type& bootstrap = bootstrap_type())
        : base_curve(settings, referenceDate, dayCounter, model,
            std::vector<Handle<Quote> >(), std::vector<Date>(), i),
          instruments_(instruments), accuracy_(1.0e-12), bootstrap_(bootstrap) {
            bootstrap_.setup(this);
        }
