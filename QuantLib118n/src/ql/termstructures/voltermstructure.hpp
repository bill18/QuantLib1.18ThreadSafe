    ...
    */
    class VolatilityTermStructure : public TermStructure {
      public:
        ...
        */
        VolatilityTermStructure(Settings* settings, BusinessDayConvention bdc,
                                const DayCounter& dc = DayCounter());
        //! initialize with a fixed reference date
        VolatilityTermStructure(Settings* settings, const Date& referenceDate,
                                const Calendar& cal,
                                BusinessDayConvention bdc,
                                const DayCounter& dc = DayCounter());
        //! calculate the reference date based on the global evaluation date
        VolatilityTermStructure(Settings* settings,
