...
namespace QuantLib {
    ...
    class CapletVarianceCurve : public OptionletVolatilityStructure {
      public:
        CapletVarianceCurve(Settings* settings, const Date &referenceDate,
    ...
    inline CapletVarianceCurve::CapletVarianceCurve(
        ...
        : OptionletVolatilityStructure(settings, referenceDate, Calendar(), Following),
          blackCurve_(settings, referenceDate, dates, capletVolCurve, dayCounter, false),
