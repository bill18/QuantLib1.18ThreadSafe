    ...
    */
    class OptionletVolatilityStructure : public VolatilityTermStructure {
      public:
        ...
        */
        OptionletVolatilityStructure(Settings* settings, BusinessDayConvention bdc = Following,
                                     const DayCounter& dc = DayCounter());
        //! initialize with a fixed reference date
        OptionletVolatilityStructure(Settings* settings, const Date& referenceDate,
                                     const Calendar& cal,
                                     BusinessDayConvention bdc,
                                     const DayCounter& dc = DayCounter());
        //! calculate the reference date based on the global evaluation date
        OptionletVolatilityStructure(Settings* settings,
