...
namespace QuantLib {
    ...
    YoYOptionletVolatilitySurface(Settings* settings,
    ...
    ConstantYoYOptionletVolatility(Settings* settings,
    							   const Volatility v,
                                   Natural settlementDays,
                                   const Calendar& cal,
                                   BusinessDayConvention bdc,
                                   ...
                                   Rate minStrike,
                                   Rate maxStrike)
    : YoYOptionletVolatilitySurface(settings, settlementDays, cal, bdc, dc,
