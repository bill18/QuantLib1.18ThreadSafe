...
namespace QuantLib {
    ...
    CapFloorTermVolCurve::CapFloorTermVolCurve(
                        ...
                        const DayCounter& dc)
    : CapFloorTermVolatilityStructure(settings, settlementDays, calendar, bdc, dc),
    ...
    : CapFloorTermVolatilityStructure(settings, settlementDate, calendar, bdc, dayCounter),
      nOptionTenors_(optionTenors.size()),
      optionTenors_(optionTenors),
      optionDates_(nOptionTenors_),
      optionTimes_(nOptionTenors_),
    ...
    CapFloorTermVolCurve::CapFloorTermVolCurve(
                                ...
                                const std::vector<Volatility>& vols,
                                const DayCounter& dayCounter)
    : CapFloorTermVolatilityStructure(settings, settlementDays, calendar, bdc, dayCounter),
      nOptionTenors_(optionTenors.size()),
      optionTenors_(optionTenors),
      optionDates_(nOptionTenors_),
      optionTimes_(nOptionTenors_),
