...
namespace QuantLib {
    ...
    SabrSmileSection::SabrSmileSection(Settings* settings,Time timeToExpiry,
                                       Rate forward,
                                       const std::vector<Real>& sabrParams,
                                       const Real shift)
        : SmileSection(settings, timeToExpiry,DayCounter(),
    ...
    SabrSmileSection::SabrSmileSection(Settings* settings, const Date& d,
                                       Rate forward,
                                       const std::vector<Real>& sabrParams,
                                       const DayCounter& dc,
                                       const Real shift)
        : SmileSection(settings, d, dc,Date(),ShiftedLognormal,shift),
          forward_(forward), shift_(shift) {
