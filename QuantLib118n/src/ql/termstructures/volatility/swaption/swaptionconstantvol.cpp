...
namespace QuantLib {
    ...
    ConstantSwaptionVolatility::ConstantSwaptionVolatility(
    		Settings* settings,
                                                    ...
                                                    const Real shift)
    : SwaptionVolatilityStructure(settings, settlementDays, cal, bdc, dc),
    ...
    ConstantSwaptionVolatility::ConstantSwaptionVolatility(
    		Settings* settings,
                                                    ...
                                                    const VolatilityType type,
                                                    const Real shift)
    : SwaptionVolatilityStructure(settings, referenceDate, cal, bdc, dc),
      volatility_(vol), maxSwapTenor_(100*Years), volatilityType_(type), shift_(shift) {
        registerWith(volatility_);
    }
    ...
    ConstantSwaptionVolatility::smileSectionImpl(const Date& d,
        ...
        return ext::shared_ptr<SmileSection>(
            new FlatSmileSection(env_, d, atmVol, dayCounter(), referenceDate(),
    ...
    ConstantSwaptionVolatility::smileSectionImpl(Time optionTime,
        ...
        Volatility atmVol = volatility_->value();
        return ext::shared_ptr<SmileSection>(
            new FlatSmileSection(env_, optionTime, atmVol, dayCounter(), Null<Rate>(),
