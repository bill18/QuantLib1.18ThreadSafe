    ...
    */
    class SwaptionVolatilityStructure : public VolatilityTermStructure {
      public:
        ...
        */
        SwaptionVolatilityStructure(Settings* settings, BusinessDayConvention bdc,
                                    const DayCounter& dc = DayCounter());
        //! initialize with a fixed reference date
        SwaptionVolatilityStructure(Settings* settings, const Date& referenceDate,
                                    const Calendar& calendar,
                                    BusinessDayConvention bdc,
                                    const DayCounter& dc = DayCounter());
        //! calculate the reference date based on the global evaluation date
        SwaptionVolatilityStructure(Settings* settings,
