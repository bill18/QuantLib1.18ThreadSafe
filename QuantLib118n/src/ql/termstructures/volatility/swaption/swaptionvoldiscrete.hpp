...
namespace QuantLib {
    ...
    class SwaptionVolatilityDiscrete : public LazyObject,
      ...
      public:
        SwaptionVolatilityDiscrete(Settings* settings,
                                   ...
                                   const DayCounter& dc);
        SwaptionVolatilityDiscrete(Settings* settings, const std::vector<Period>& optionTenors,
                                   const std::vector<Period>& swapTenors,
                                   const Date& referenceDate,
                                   const Calendar& cal,
                                   BusinessDayConvention bdc,
                                   const DayCounter& dc);
        SwaptionVolatilityDiscrete(Settings* settings, const std::vector<Date>& optionDates,
                                   const std::vector<Period>& swapTenors,
                                   const Date& referenceDate,
                                   const Calendar& cal,
                                   BusinessDayConvention bdc,
