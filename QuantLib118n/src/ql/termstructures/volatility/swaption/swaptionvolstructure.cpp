...
namespace QuantLib {
    ...
    SwaptionVolatilityStructure::SwaptionVolatilityStructure(Settings* settings,
    ...
    SwaptionVolatilityStructure::SwaptionVolatilityStructure(
                                                ...
                                                BusinessDayConvention bdc,
                                                const DayCounter& dc)
    : VolatilityTermStructure(settings, referenceDate, calendar, bdc, dc) {}
    ...
    SwaptionVolatilityStructure::SwaptionVolatilityStructure(
    		Settings* settings,
                                                ...
                                                BusinessDayConvention bdc,
                                                const DayCounter& dc)
    : VolatilityTermStructure(settings, settlementDays, calendar, bdc, dc) {}
