...
namespace QuantLib {
    ...
    class SmileSection : public virtual Observable,
      ...
      public:
        SmileSection(Settings* settings, const Date& d,
                     const DayCounter& dc = DayCounter(),
                     const Date& referenceDate = Date(),
                     const VolatilityType type = ShiftedLognormal,
                     const Rate shift = 0.0);
        SmileSection(Settings* settings, Time exerciseTime,
                     const DayCounter& dc = DayCounter(),
                     const VolatilityType type = ShiftedLognormal,
                     const Rate shift = 0.0);
        SmileSection(Settings* settings):env_(settings) {}
//        SmileSection(const SmileSection& other) {
