    ...
    */
    class LocalVolTermStructure : public VolatilityTermStructure {
      public:
        ...
        */
        LocalVolTermStructure(Settings* settings, BusinessDayConvention bdc = Following,
                              const DayCounter& dc = DayCounter());
        //! initialize with a fixed reference date
        LocalVolTermStructure(Settings* settings, const Date& referenceDate,
                              const Calendar& cal = Calendar(),
                              BusinessDayConvention bdc = Following,
                              const DayCounter& dc = DayCounter());
        //! calculate the reference date based on the global evaluation date
        LocalVolTermStructure(Settings* settings,
