...
namespace QuantLib {
    ...
    */
    class ImpliedVolTermStructure : public BlackVarianceTermStructure {
      public:
        ImpliedVolTermStructure(Settings* settings, const Handle<BlackVolTermStructure>& origTS,
    ...
    inline ImpliedVolTermStructure::ImpliedVolTermStructure(
                              ...
                              const Date& referenceDate)
    : BlackVarianceTermStructure(settings, referenceDate), originalTS_(originalTS) {
