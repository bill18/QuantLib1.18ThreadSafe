...
namespace QuantLib {
    ...
    */
    class BlackConstantVol : public BlackVolatilityTermStructure {
      public:
        BlackConstantVol(Settings* settings, const Date& referenceDate,
                         const Calendar&,
        ...
        BlackConstantVol(Settings* settings, const Date& referenceDate,
                         ...
                         const DayCounter& dayCounter);
        BlackConstantVol(Settings* settings,
    ...
    inline BlackConstantVol::BlackConstantVol(Settings* settings, const Date& referenceDate,
                                              const Calendar& cal,
                                              Volatility volatility,
                                              const DayCounter& dc)
    : BlackVolatilityTermStructure(settings, referenceDate, cal, Following, dc),
    ...
    inline BlackConstantVol::BlackConstantVol(Settings* settings,
    										  Natural settlementDays,
                                              const Calendar& cal,
                                              Volatility volatility,
                                              const DayCounter& dc)
    : BlackVolatilityTermStructure(settings, settlementDays, cal, Following, dc),
      volatility_(ext::shared_ptr<Quote>(new SimpleQuote(volatility))) {}
