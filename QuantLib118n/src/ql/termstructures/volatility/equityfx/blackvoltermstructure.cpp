...
namespace QuantLib {
    ...
    BlackVolTermStructure::BlackVolTermStructure(Settings* settings, BusinessDayConvention bdc,
                                                 const DayCounter& dc)
    : VolatilityTermStructure(settings, bdc, dc) {}

    BlackVolTermStructure::BlackVolTermStructure(Settings* settings, const Date& refDate,
                                                 const Calendar& cal,
                                                 BusinessDayConvention bdc,
                                                 const DayCounter& dc)
    : VolatilityTermStructure(settings, refDate, cal, bdc, dc) {}

    BlackVolTermStructure::BlackVolTermStructure(Settings* settings,
    											 Natural settlDays,
                                                 const Calendar& cal,
                                                 BusinessDayConvention bdc,
                                                 const DayCounter& dc)
    : VolatilityTermStructure(settings, settlDays, cal, bdc, dc) {}
    ...
    BlackVolatilityTermStructure::BlackVolatilityTermStructure(
    		Settings* settings,
                                                    BusinessDayConvention bdc,
                                                    const DayCounter& dc)
    : BlackVolTermStructure(settings, bdc, dc) {}
    ...
    BlackVolatilityTermStructure::BlackVolatilityTermStructure(
    		Settings* settings,
                                                    ...
                                                    BusinessDayConvention bdc,
                                                    const DayCounter& dc)
    : BlackVolTermStructure(settings, refDate, cal, bdc, dc) {}
    ...
    BlackVolatilityTermStructure::BlackVolatilityTermStructure(
                                                    ...
                                                    BusinessDayConvention bdc,
                                                    const DayCounter& dc)
    : BlackVolTermStructure(settings, settlementDays, cal, bdc, dc) {}
