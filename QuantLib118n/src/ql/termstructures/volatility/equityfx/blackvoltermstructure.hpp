    ...
    */
    class BlackVolTermStructure : public VolatilityTermStructure {
      public:
        ...
        */
        BlackVolTermStructure(Settings* settings, BusinessDayConvention bdc = Following,
                              const DayCounter& dc = DayCounter());
        //! initialize with a fixed reference date
        BlackVolTermStructure(Settings* settings, const Date& referenceDate,
                              const Calendar& cal = Calendar(),
                              BusinessDayConvention bdc = Following,
                              const DayCounter& dc = DayCounter());
        //! calculate the reference date based on the global evaluation date
        BlackVolTermStructure(Settings* settings,
      ...
      public:
        ...
        */
        ...
        /*! \warning term structures initialized by means of this
                     ...
                     by overriding the referenceDate() method.
        */
        BlackVolatilityTermStructure(Settings* settings, BusinessDayConvention bdc = Following,
                                     const DayCounter& dc = DayCounter());
        //! initialize with a fixed reference date
        BlackVolatilityTermStructure(Settings* settings, const Date& referenceDate,
                                     const Calendar& cal = Calendar(),
                                     BusinessDayConvention bdc = Following,
                                     const DayCounter& dc = DayCounter());
        //! calculate the reference date based on the global evaluation date
        BlackVolatilityTermStructure(Settings* settings,
        							 Natural settlementDays,
                                     const Calendar& cal,
                                     BusinessDayConvention bdc = Following,
                                     const DayCounter& dc = DayCounter());
      ...
      public:
        ...
        */
        ...
        /*! \warning term structures initialized by means of this
                     ...
                     by overriding the referenceDate() method.
        */
        BlackVarianceTermStructure(Settings* settings, BusinessDayConvention bdc = Following,
                                   const DayCounter& dc = DayCounter());
        //! initialize with a fixed reference date
        BlackVarianceTermStructure(Settings* settings, const Date& referenceDate,
                                   const Calendar& cal = Calendar(),
                                   BusinessDayConvention bdc = Following,
                                   const DayCounter& dc = DayCounter());
        //! calculate the reference date based on the global evaluation date
        BlackVarianceTermStructure(Settings* settings,
        						   Natural settlementDays,
                                   const Calendar&,
                                   BusinessDayConvention bdc = Following,
                                   const DayCounter& dc = DayCounter());
