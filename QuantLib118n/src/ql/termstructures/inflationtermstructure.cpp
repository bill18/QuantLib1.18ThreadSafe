...
namespace QuantLib {
    ...
    : TermStructure(settings, dayCounter),
    ...
    InflationTermStructure::InflationTermStructure(
                                        ...
                                        const DayCounter& dayCounter,
                                        const ext::shared_ptr<Seasonality> &seasonality)
    : TermStructure(settings, referenceDate, calendar, dayCounter),
    ...
    InflationTermStructure::InflationTermStructure(
                                        ...
                                        const DayCounter &dayCounter,
                                        const ext::shared_ptr<Seasonality> &seasonality)
    : TermStructure(settings, settlementDays, calendar, dayCounter),
      observationLag_(observationLag),
      frequency_(frequency), indexIsInterpolated_(indexIsInterpolated),
      baseRate_(baseRate), nominalTermStructure_(yTS) {
        registerWith(nominalTermStructure_);
    ...
    ZeroInflationTermStructure::ZeroInflationTermStructure(
                                    ...
                                    const Handle<YieldTermStructure>& yTS,
                                    const ext::shared_ptr<Seasonality> &seasonality)
    : InflationTermStructure(settings, baseZeroRate, observationLag, frequency, indexIsInterpolated,
    ...
    ZeroInflationTermStructure::ZeroInflationTermStructure(
                                    ...
                                    const Handle<YieldTermStructure>& yTS,
                                    const ext::shared_ptr<Seasonality> &seasonality)
    : InflationTermStructure(settings, referenceDate, baseZeroRate, observationLag, frequency, indexIsInterpolated,
    ...
    ZeroInflationTermStructure::ZeroInflationTermStructure(
                                    ...
                                    const Handle<YieldTermStructure>& yTS,
                                    const ext::shared_ptr<Seasonality> &seasonality)
    : InflationTermStructure(settings, settlementDays, calendar, baseZeroRate, observationLag, frequency, indexIsInterpolated,
                             yTS, dayCounter, seasonality) {
    }
    ...
    YoYInflationTermStructure::YoYInflationTermStructure(
    		Settings* settings,
                                    ...
                                    const Handle<YieldTermStructure>& yTS,
                                    const ext::shared_ptr<Seasonality> &seasonality)
    : InflationTermStructure(settings, baseYoYRate, observationLag, frequency, indexIsInterpolated,
                             yTS, dayCounter, seasonality) {}
    ...
    YoYInflationTermStructure::YoYInflationTermStructure(
    		Settings* settings,
                                    ...
                                    const Handle<YieldTermStructure>& yTS,
                                    const ext::shared_ptr<Seasonality> &seasonality)
    : InflationTermStructure(settings, referenceDate, baseYoYRate, observationLag, frequency, indexIsInterpolated,
                             yTS, calendar, dayCounter, seasonality) {}
    ...
    YoYInflationTermStructure::YoYInflationTermStructure(
    		Settings* settings,
                                    ...
                                    const Handle<YieldTermStructure>& yTS,
                                    const ext::shared_ptr<Seasonality> &seasonality)
    : InflationTermStructure(settings, settlementDays, calendar, baseYoYRate, observationLag,
