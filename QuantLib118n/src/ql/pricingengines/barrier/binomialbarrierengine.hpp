      ...
      public:
        ...
        */
        BinomialBarrierEngine(
             ...
             Size timeSteps,
             Size maxTimeSteps=0)
        : BarrierOption::engine(settings), process_(process), timeSteps_(timeSteps), maxTimeSteps_(maxTimeSteps) {
    ...
    void BinomialBarrierEngine<T,D>::calculate() const {
        ...
        Handle<YieldTermStructure> flatRiskFree(
            ext::shared_ptr<YieldTermStructure>(
                new FlatForward(env_, referenceDate, r, rfdc)));
        ...
        ext::shared_ptr<StochasticProcess1D> bs(
                         new GeneralizedBlackScholesProcess(env_, 
