...
namespace QuantLib {
    ...
    DiscretizedSwap::DiscretizedSwap(Settings* settings, const VanillaSwap::arguments& args,
                                     const Date& referenceDate,
                                     const DayCounter& dayCounter)
    : arguments_(args), env_(settings) {
        includeTodaysCashFlows_ = env_->includeTodaysCashFlows() &&
                                  *env_->includeTodaysCashFlows();
