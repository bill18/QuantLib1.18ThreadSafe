...
namespace QuantLib {
    ...
    TreeVanillaSwapEngine::TreeVanillaSwapEngine(Settings* settings, const ext::shared_ptr<ShortRateModel>& model,
                                                 Size timeSteps,
                                                 const Handle<YieldTermStructure>& termStructure)
    : LatticeShortRateModelEngine<VanillaSwap::arguments, VanillaSwap::results>(settings, model, timeSteps),
    ...
    TreeVanillaSwapEngine::TreeVanillaSwapEngine(Settings* settings, const ext::shared_ptr<ShortRateModel>& model,
                                                 ...
                                                 const Handle<YieldTermStructure>& termStructure)
    : LatticeShortRateModelEngine<VanillaSwap::arguments, VanillaSwap::results>(settings, model, timeGrid),
      termStructure_(termStructure),
	  env_(settings) {
        registerWith(termStructure_);
    }
    ...
    void TreeVanillaSwapEngine::calculate() const {
        ...
        DiscretizedSwap swap(env_, arguments_, referenceDate, dayCounter);
