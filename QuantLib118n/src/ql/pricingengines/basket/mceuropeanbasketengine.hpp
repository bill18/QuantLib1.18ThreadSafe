...
namespace QuantLib {
    ...
    */
    ...
    class MCEuropeanBasketEngine  : public BasketOption::engine,
      ...
      public:
        ...
        typedef typename McSimulation<MultiVariate,RNG,S>::stats_type
            stats_type;
        // constructor
        MCEuropeanBasketEngine(Settings* settings, const ext::shared_ptr<StochasticProcessArray>&,
                               Size timeSteps,
    ...
    inline MCEuropeanBasketEngine<RNG,S>::MCEuropeanBasketEngine(
                   ...
                   Size maxSamples,
                   BigNatural seed)
    : BasketOption::engine(settings), McSimulation<MultiVariate,RNG,S>(antitheticVariate, false),
    ...
    ext::shared_ptr<PricingEngine>() const {
        ...
        return ext::shared_ptr<PricingEngine>(new
            MCEuropeanBasketEngine<RNG,S>(env_, process_,
                                          steps_,
                                          stepsPerYear_,
                                          brownianBridge_,
                                          antithetic_,
