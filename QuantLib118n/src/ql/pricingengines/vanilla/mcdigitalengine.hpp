...
namespace QuantLib {
    ...
    */
    ...
    MCDigitalEngine<RNG,S>::MCDigitalEngine(
             ...
             Size maxSamples,
             BigNatural seed)
    : MCVanillaEngine<SingleVariate,RNG,S>(settings, process,
                                           timeSteps,
                                           timeStepsPerYear,
                                           brownianBridge,
                                           antitheticVariate,
    ...
    : process_(process), antithetic_(false),
      ...
      tolerance_(Null<Real>()), brownianBridge_(false), seed_(0), env_(settings) {}
    ...
    MakeMCDigitalEngine<RNG,S>::operator ext::shared_ptr<PricingEngine>()
        ...
        return ext::shared_ptr<PricingEngine>(new
            MCDigitalEngine<RNG,S>(env_, process_,
                                   steps_,
                                   stepsPerYear_,
                                   brownianBridge_,
                                   antithetic_,
