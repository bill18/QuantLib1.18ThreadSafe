...
namespace QuantLib {
    ...
    : GenericModelEngine<BatesModel,
                         ...
                         DividendVanillaOption::results>(settings, model),
    ...
    void FdBatesVanillaEngine::calculate() const {
        FdHestonVanillaEngine helperEngine(env_, model_.currentLink(),
        ...
        *dynamic_cast<DividendVanillaOption::arguments*>(
        ...
        ext::shared_ptr<FdmBatesSolver> solver(
            new FdmBatesSolver(env_, Handle<BatesProcess>(process),
