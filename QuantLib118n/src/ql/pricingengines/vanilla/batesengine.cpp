...
namespace QuantLib {
    ...
    BatesEngine::BatesEngine(Settings* settings, const ext::shared_ptr<BatesModel> & model,
                             Size integrationOrder)
    : AnalyticHestonEngine(settings, model, integrationOrder) { }

    BatesEngine::BatesEngine(Settings* settings, const ext::shared_ptr<BatesModel>& model,
                             Real relTolerance, Size maxEvaluations)
    : AnalyticHestonEngine(settings, model, relTolerance, maxEvaluations) { }
    ...
    BatesDetJumpEngine::BatesDetJumpEngine(
        ...
        Size integrationOrder)
    : BatesEngine(settings, model, integrationOrder) { }

    BatesDetJumpEngine::BatesDetJumpEngine(
    		Settings* settings,
        const ext::shared_ptr<BatesDetJumpModel>& model,
        Real relTolerance, Size maxEvaluations)
    : BatesEngine(settings, model, relTolerance, maxEvaluations) { }
    ...
    BatesDoubleExpDetJumpEngine::BatesDoubleExpDetJumpEngine(
        ...
        Size integrationOrder)
    : BatesDoubleExpEngine(settings, model, integrationOrder) { }

    BatesDoubleExpDetJumpEngine::BatesDoubleExpDetJumpEngine(
    		Settings* settings,
        const ext::shared_ptr<BatesDoubleExpDetJumpModel>& model,
        Real relTolerance, Size maxEvaluations)
    : BatesDoubleExpEngine(settings, model, relTolerance, maxEvaluations) { }
