...
namespace QuantLib {
    ...
    */
    ...
    class MCEuropeanHestonEngine
      ...
      public:
        typedef typename MCVanillaEngine<MultiVariate,RNG,S>::path_pricer_type
            path_pricer_type;
        MCEuropeanHestonEngine(Settings* settings, const ext::shared_ptr<P>&,
                               Size timeSteps,
    ...
    class MakeMCEuropeanHestonEngine {
      public:
        explicit MakeMCEuropeanHestonEngine(Settings* settings, const ext::shared_ptr<P>&);
        // named parameters
    ...
    operator ext::shared_ptr<PricingEngine>() const {
        ...
        return ext::shared_ptr<PricingEngine>(
               new MCEuropeanHestonEngine<RNG,S,P>(env_, process_,
                                                   steps_,
                                                   stepsPerYear_,
                                                   antithetic_,
                                                   samples_, tolerance_,
