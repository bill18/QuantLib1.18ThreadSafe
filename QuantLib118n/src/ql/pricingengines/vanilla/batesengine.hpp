...
namespace QuantLib {
    ...
    */
    class BatesEngine : public AnalyticHestonEngine {
      public:
        explicit BatesEngine(Settings* settings, const ext::shared_ptr<BatesModel>& model,
                             Size integrationOrder = 144);
        BatesEngine(Settings* settings, const ext::shared_ptr<BatesModel>& model,
    ...
    class BatesDetJumpEngine : public BatesEngine {
      public:
        explicit BatesDetJumpEngine(Settings* settings, const ext::shared_ptr<BatesDetJumpModel>& model,
                                    Size integrationOrder = 144);
        BatesDetJumpEngine(Settings* settings, const ext::shared_ptr<BatesDetJumpModel>& model,
                           Real relTolerance, Size maxEvaluations);
    ...
    class BatesDoubleExpEngine : public AnalyticHestonEngine {
      public:
        explicit BatesDoubleExpEngine(Settings* settings,
            const ext::shared_ptr<BatesDoubleExpModel>& model,
            Size integrationOrder = 144);
        BatesDoubleExpEngine(Settings* settings,
            const ext::shared_ptr<BatesDoubleExpModel>& model,
            Real relTolerance, Size maxEvaluations);
    ...
    class BatesDoubleExpDetJumpEngine : public BatesDoubleExpEngine {
      public:
        explicit BatesDoubleExpDetJumpEngine(Settings* settings,
            const ext::shared_ptr<BatesDoubleExpDetJumpModel>& model,
            Size integrationOrder = 144);
        BatesDoubleExpDetJumpEngine(Settings* settings,
            const ext::shared_ptr<BatesDoubleExpDetJumpModel>& model,
            Real relTolerance, Size maxEvaluations);
