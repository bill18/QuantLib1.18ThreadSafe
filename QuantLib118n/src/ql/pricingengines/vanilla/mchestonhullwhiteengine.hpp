...
namespace QuantLib {
    ...
    inline MCHestonHullWhiteEngine<RNG,S>::MCHestonHullWhiteEngine(
              ...
              Size maxSamples,
              BigNatural seed)
    : base_type(settings, process, timeSteps, timeStepsPerYear,
                false, antitheticVariate,
                controlVariate, requiredSamples,
                requiredTolerance, maxSamples, seed),
      process_(process), env_(settings) {}
    ...
    MCHestonHullWhiteEngine<RNG,S>::controlPricingEngine() const {
        ...
        ext::shared_ptr<HestonModel> hestonModel(
                                              new HestonModel(env_, hestonProcess));
        ...
        return ext::shared_ptr<PricingEngine>(
                new AnalyticHestonHullWhiteEngine(env_, hestonModel, hwModel, 144));
    }
    ...
    ext::shared_ptr<PricingEngine>() const {
        ...
        return ext::shared_ptr<PricingEngine>(new
            MCHestonHullWhiteEngine<RNG,S>(env_,
                                           process_,
                                           steps_,
                                           stepsPerYear_,
                                           antithetic_,
