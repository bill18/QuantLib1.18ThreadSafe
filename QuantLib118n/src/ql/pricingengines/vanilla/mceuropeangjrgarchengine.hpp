...
namespace QuantLib {
    ...
    */
    ...
    class MCEuropeanGJRGARCHEngine
      ...
      public:
        typedef typename MCVanillaEngine<MultiVariate,RNG,S>::path_pricer_type
            path_pricer_type;
        MCEuropeanGJRGARCHEngine(Settings* settings, const ext::shared_ptr<GJRGARCHProcess>&,
                               Size timeSteps,
    ...
    class MakeMCEuropeanGJRGARCHEngine {
      public:
        MakeMCEuropeanGJRGARCHEngine(Settings* settings, const ext::shared_ptr<GJRGARCHProcess>&);
        // named parameters
    ...
    : MCVanillaEngine<MultiVariate,RNG,S>(settings, process, timeSteps, timeStepsPerYear,
    ...
    : process_(process), antithetic_(false),
      ...
      tolerance_(Null<Real>()), seed_(0), env_(settings) {}
    ...
    operator ext::shared_ptr<PricingEngine>() const {
        ...
        return ext::shared_ptr<PricingEngine>(
                 new MCEuropeanGJRGARCHEngine<RNG,S>(env_, process_,
                                                   steps_,
                                                   stepsPerYear_,
                                                   antithetic_,
                                                   samples_, tolerance_,
