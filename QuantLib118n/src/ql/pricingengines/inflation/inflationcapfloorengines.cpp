...
namespace QuantLib {
    ...
    : YoYInflationCapFloor::engine(settings), index_(index), volatility_(volatility),
    ...
    YoYInflationBlackCapFloorEngine::YoYInflationBlackCapFloorEngine(
    		Settings* settings,
                    ...
                    const Handle<YoYOptionletVolatilitySurface>& volatility,
                    const Handle<YieldTermStructure>& nominalTermStructure)
    : YoYInflationCapFloorEngine(settings, index, volatility, nominalTermStructure) {}

    YoYInflationBlackCapFloorEngine::YoYInflationBlackCapFloorEngine(
    		Settings* settings,
                    const ext::shared_ptr<YoYInflationIndex>& index,
                    const Handle<YoYOptionletVolatilitySurface>& volatility)
    : YoYInflationCapFloorEngine(settings, index, volatility,
