...
namespace QuantLib {
    ...
    class BlackStyleSwaptionEngine : public Swaption::engine {
      public:
        ...
        BlackStyleSwaptionEngine(Settings* settings,
        ...
        BlackStyleSwaptionEngine(Settings* settings,
                            ...
                            Real displacement = 0.0,
                            CashAnnuityModel model = DiscountCurve);
        BlackStyleSwaptionEngine(Settings* settings, const Handle<YieldTermStructure>& discountCurve,
...
//        Settings* env_;
    ...
    */
    ...
    class BlackSwaptionEngine
      ...
      public:
        BlackSwaptionEngine(Settings* settings,
        					const Handle<YieldTermStructure>& discountCurve,
                            Volatility vol,
                            const DayCounter& dc = Actual365Fixed(),
                            Real displacement = 0.0,
        ...
        BlackSwaptionEngine(Settings* settings,
                            ...
                            Real displacement = 0.0,
                            CashAnnuityModel model = DiscountCurve);
        BlackSwaptionEngine(Settings* settings, const Handle<YieldTermStructure>& discountCurve,
                            const Handle<SwaptionVolatilityStructure>& vol,
                            CashAnnuityModel model = DiscountCurve);
    };
    ...
    */
    ...
    class BachelierSwaptionEngine
      ...
      public:
        BachelierSwaptionEngine(Settings* settings,
        					    const Handle<YieldTermStructure>& discountCurve,
                                Volatility vol,
                                const DayCounter& dc = Actual365Fixed(),
                                CashAnnuityModel model = DiscountCurve);
        BachelierSwaptionEngine(Settings* settings,
                                ...
                                const DayCounter& dc = Actual365Fixed(),
                                CashAnnuityModel model = DiscountCurve);
        BachelierSwaptionEngine(Settings* settings, const Handle<YieldTermStructure>& discountCurve,
                                const Handle<SwaptionVolatilityStructure>& vol,
                                CashAnnuityModel model = DiscountCurve);
    };
    ...
    BlackStyleSwaptionEngine<Spec>::BlackStyleSwaptionEngine(
        ...
        : Swaption::engine(settings), discountCurve_(discountCurve),
          vol_(ext::shared_ptr<SwaptionVolatilityStructure>(
              new ConstantSwaptionVolatility(settings, 0, NullCalendar(), Following, vol,
    ...
    BlackStyleSwaptionEngine<Spec>::BlackStyleSwaptionEngine(
        ...
        CashAnnuityModel model)
        : Swaption::engine(settings), discountCurve_(discountCurve), vol_(volatility),
          model_(model) {
        registerWith(discountCurve_);
        registerWith(vol_);
    }
    ...
    void BlackStyleSwaptionEngine<Spec>::calculate() const {
        ...
        swap.setPricingEngine(ext::shared_ptr<PricingEngine>(new
            DiscountingSwapEngine(env_, discountCurve_, false)));
        ...
        swap.setPricingEngine(ext::shared_ptr<PricingEngine>(
                           new DiscountingSwapEngine(env_, discountCurve_, false)));
        Real annuity;
