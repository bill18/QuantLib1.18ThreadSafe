...
namespace QuantLib {
    ...
    : LatticeShortRateModelEngine<Swaption::arguments,
                                  Swaption::results>(settings, model, timeSteps),
      termStructure_(termStructure), env_(settings) {
    ...
    TreeSwaptionEngine::TreeSwaptionEngine(
    		Settings* settings,
                              ...
                              const Handle<YieldTermStructure>& termStructure)
    : LatticeShortRateModelEngine<Swaption::arguments,
                                  Swaption::results>(settings, model, timeGrid),
      termStructure_(termStructure), env_(settings) {
        registerWith(termStructure_);
    }
    ...
    void TreeSwaptionEngine::calculate() const {
        ...
        DiscretizedSwaption swaption(env_, arguments_, referenceDate, dayCounter);
