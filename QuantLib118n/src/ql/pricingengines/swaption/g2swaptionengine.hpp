    ...
    */
    class G2SwaptionEngine : public GenericModelEngine<G2, Swaption::arguments,
      ...
      public:
        ...
        G2SwaptionEngine(Settings* settings, const ext::shared_ptr<G2>& model,
                         Real range,
                         Size intervals)
        : GenericModelEngine<G2, Swaption::arguments, Swaption::results>(settings, model),
        ...
        void calculate() const {
            ...
            swap.setPricingEngine(ext::shared_ptr<PricingEngine>(
                  new DiscountingSwapEngine(env_, model_->termStructure(), false)));
