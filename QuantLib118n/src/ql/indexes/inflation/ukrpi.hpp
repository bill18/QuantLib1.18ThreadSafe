...
namespace QuantLib {
    ...
    class UKRPI : public ZeroInflationIndex {
      public:
        UKRPI(Settings* settings, bool interpolated,
              const Handle<ZeroInflationTermStructure>& ts =
                    Handle<ZeroInflationTermStructure>())
        : ZeroInflationIndex(settings, "RPI",
                             UKRegion(),
                             false,
                             interpolated,
                             Monthly,
    ...
    class YYUKRPI : public YoYInflationIndex {
      public:
        YYUKRPI(Settings* settings, bool interpolated,
                const Handle<YoYInflationTermStructure>& ts =
                        Handle<YoYInflationTermStructure>())
        : YoYInflationIndex(settings, "YY_RPI",
                            UKRegion(),
                            false,
                            interpolated,
                            false,
    ...
    class YYUKRPIr : public YoYInflationIndex {
      public:
        YYUKRPIr(Settings* settings, bool interpolated,
                 const Handle<YoYInflationTermStructure>& ts =
                        Handle<YoYInflationTermStructure>())
        : YoYInflationIndex(settings, "YYR_RPI",
                            UKRegion(),
                            false,
                            interpolated,
                            true,
