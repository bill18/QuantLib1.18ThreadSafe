...
namespace QuantLib {
    ...
    Libor::Libor(Settings* settings, const std::string& familyName,
                 const Period& tenor,
    ...
    : IborIndex(settings, familyName, tenor, settlementDays, currency,
    ...
    ext::shared_ptr<IborIndex> Libor::clone(
        ...
        return ext::shared_ptr<IborIndex>(new Libor(env_, familyName(),
                                                      tenor(),
                                                      fixingDays(),
                                                      currency(),
    ...
    DailyTenorLibor::DailyTenorLibor(
    		Settings* settings,
                 ...
                 const DayCounter& dayCounter,
                 const Handle<YieldTermStructure>& h)
    : IborIndex(settings, familyName, 1*Days, settlementDays, currency,
                // http://www.bba.org.uk/bba/jsp/polopoly.jsp?d=225&a=1412 :
