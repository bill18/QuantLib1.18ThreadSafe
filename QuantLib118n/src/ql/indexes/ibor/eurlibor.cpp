...
namespace QuantLib {
    ...
    EURLibor::EURLibor(Settings* settings, const Period& tenor,
                       const Handle<YieldTermStructure>& h)
    : IborIndex(settings, "EURLibor", tenor,
                2,
                EURCurrency(),
    ...
    DailyTenorEURLibor::DailyTenorEURLibor(Settings* settings, Natural settlementDays,
                                           const Handle<YieldTermStructure>& h)
    : IborIndex(settings, "EURLibor", 1*Days,
                settlementDays,
                EURCurrency(),
                // http://www.bba.org.uk/bba/jsp/polopoly.jsp?d=225&a=1412 :
