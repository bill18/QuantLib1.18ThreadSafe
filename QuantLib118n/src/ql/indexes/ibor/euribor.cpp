...
namespace QuantLib {
    ...
    Euribor::Euribor(Settings* settings, const Period& tenor,
                     const Handle<YieldTermStructure>& h)
    : IborIndex(settings, "Euribor", tenor,
                2, // settlement days
                EURCurrency(), TARGET(),
    ...
    Euribor365::Euribor365(Settings* settings, const Period& tenor,
                           const Handle<YieldTermStructure>& h)
    : IborIndex(settings, "Euribor365", tenor,
                2, // settlement days
                EURCurrency(), TARGET(),
                euriborConvention(tenor), euriborEOM(tenor),
                Actual365Fixed(), h) {
