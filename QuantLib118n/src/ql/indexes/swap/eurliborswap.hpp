...
namespace QuantLib {
    ...
    */
    class EurLiborSwapIsdaFixA : public SwapIndex {
      public:
        EurLiborSwapIsdaFixA(Settings* settings, const Period& tenor,
    ...
    */
    class EurLiborSwapIsdaFixB : public SwapIndex {
      public:
        EurLiborSwapIsdaFixB(Settings* settings, const Period& tenor,
                             const Handle<YieldTermStructure>& h =
                                    Handle<YieldTermStructure>());
        EurLiborSwapIsdaFixB(Settings* settings, const Period& tenor,
                             const Handle<YieldTermStructure>& forwarding,
    ...
    */
    class EurLiborSwapIfrFix : public SwapIndex {
      public:
        EurLiborSwapIfrFix(Settings* settings, const Period& tenor,
                           const Handle<YieldTermStructure>& h =
                                    Handle<YieldTermStructure>());
        EurLiborSwapIfrFix(Settings* settings, const Period& tenor,
                           const Handle<YieldTermStructure>& forwarding,
