...
namespace QuantLib {
    ...
    */
    class EuriborSwapIsdaFixA : public SwapIndex {
      public:
        EuriborSwapIsdaFixA(Settings* settings, const Period& tenor,
    ...
    */
    class EuriborSwapIsdaFixB : public SwapIndex {
      public:
        EuriborSwapIsdaFixB(Settings* settings, const Period& tenor,
                            const Handle<YieldTermStructure>& h =
                                    Handle<YieldTermStructure>());
        EuriborSwapIsdaFixB(Settings* settings, const Period& tenor,
                            const Handle<YieldTermStructure>& forwarding,
    ...
    */
    class EuriborSwapIfrFix : public SwapIndex {
      public:
        EuriborSwapIfrFix(Settings* settings, const Period& tenor,
                          const Handle<YieldTermStructure>& h =
                                    Handle<YieldTermStructure>());
        EuriborSwapIfrFix(Settings* settings, const Period& tenor,
                          const Handle<YieldTermStructure>& forwarding,
