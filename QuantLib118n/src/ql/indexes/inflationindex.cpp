...
namespace QuantLib {
    ...
    InflationIndex::InflationIndex(Settings* settings, const std::string& familyName,
                                   const Region& region,
                                   bool revised,
                                   bool interpolated,
                                   Frequency frequency,
    ...
    : InflationIndex(settings, familyName, region, revised, interpolated,
    ...
    ext::shared_ptr<ZeroInflationIndex> ZeroInflationIndex::clone(
        ...
        return ext::make_shared<ZeroInflationIndex>(env_,
    ...
    ext::shared_ptr<YoYInflationIndex> YoYInflationIndex::clone(
        ...
        return ext::make_shared<YoYInflationIndex>(env_,
                      familyName_, region_, revised_,
