...
namespace QuantLib {
    ...
    class InflationIndex : public Index, public Observer {
      public:
         ...
         */
        InflationIndex(Settings* settings, const std::string& familyName,
                       const Region& region,
                       bool revised,
                       bool interpolated,
                       Frequency frequency,
    ...
    class ZeroInflationIndex : public InflationIndex {
      public:
        ...
        ZeroInflationIndex(Settings* settings, const std::string& familyName,
                           const Region& region,
                           bool revised,
                           bool interpolated,
                           Frequency frequency,
    ...
    */
    class YoYInflationIndex : public InflationIndex {
      public:
        YoYInflationIndex(Settings* settings, const std::string& familyName,
                          const Region& region,
                          bool revised,
                          bool interpolated,
